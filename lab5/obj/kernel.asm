...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	57e060ef          	jal	ra,ffffffffc02065c8 <memset>
...
ffffffffc0200056:	5a658593          	addi	a1,a1,1446 # ffffffffc02065f8 <etext+0x6>
ffffffffc020005a:	00006517          	auipc	a0,0x6
ffffffffc020005e:	5be50513          	addi	a0,a0,1470 # ffffffffc0206618 <etext+0x26>
...
ffffffffc020007a:	4c7050ef          	jal	ra,ffffffffc0205d40 <proc_init>
...
ffffffffc020008e:	64b050ef          	jal	ra,ffffffffc0205ed8 <cpu_idle>
...
ffffffffc02000ac:	57850513          	addi	a0,a0,1400 # ffffffffc0206620 <etext+0x2e>
...
ffffffffc02000c2:	2cab8b93          	addi	s7,s7,714 # ffffffffc02a7388 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
...
ffffffffc020011e:	26e50513          	addi	a0,a0,622 # ffffffffc02a7388 <buf>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	056060ef          	jal	ra,ffffffffc02061ca <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	020060ef          	jal	ra,ffffffffc02061ca <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020020e:	41e50513          	addi	a0,a0,1054 # ffffffffc0206628 <etext+0x36>
void print_kerninfo(void) {
...
ffffffffc0200224:	42850513          	addi	a0,a0,1064 # ffffffffc0206648 <etext+0x56>
ffffffffc0200228:	f59ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020022c:	00006597          	auipc	a1,0x6
ffffffffc0200230:	3c658593          	addi	a1,a1,966 # ffffffffc02065f2 <etext>
ffffffffc0200234:	00006517          	auipc	a0,0x6
ffffffffc0200238:	43450513          	addi	a0,a0,1076 # ffffffffc0206668 <etext+0x76>
ffffffffc020023c:	f45ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  edata  0x%08x (virtual)\n", edata);
ffffffffc0200240:	000a7597          	auipc	a1,0xa7
ffffffffc0200244:	14858593          	addi	a1,a1,328 # ffffffffc02a7388 <buf>
ffffffffc0200248:	00006517          	auipc	a0,0x6
ffffffffc020024c:	44050513          	addi	a0,a0,1088 # ffffffffc0206688 <etext+0x96>
ffffffffc0200250:	f31ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  end    0x%08x (virtual)\n", end);
ffffffffc0200254:	000b2597          	auipc	a1,0xb2
ffffffffc0200258:	69058593          	addi	a1,a1,1680 # ffffffffc02b28e4 <end>
ffffffffc020025c:	00006517          	auipc	a0,0x6
ffffffffc0200260:	44c50513          	addi	a0,a0,1100 # ffffffffc02066a8 <etext+0xb6>
ffffffffc0200264:	f1dff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("Kernel executable memory footprint: %dKB\n",
            (end - kern_init + 1023) / 1024);
ffffffffc0200268:	000b3597          	auipc	a1,0xb3
ffffffffc020026c:	a7b58593          	addi	a1,a1,-1413 # ffffffffc02b2ce3 <end+0x3ff>
...
ffffffffc020028e:	43e50513          	addi	a0,a0,1086 # ffffffffc02066c8 <etext+0xd6>
}
...
ffffffffc020029c:	46060613          	addi	a2,a2,1120 # ffffffffc02066f8 <etext+0x106>
ffffffffc02002a0:	04d00593          	li	a1,77
ffffffffc02002a4:	00006517          	auipc	a0,0x6
ffffffffc02002a8:	46c50513          	addi	a0,a0,1132 # ffffffffc0206710 <etext+0x11e>
void print_stackframe(void) {
...
ffffffffc02002b8:	47460613          	addi	a2,a2,1140 # ffffffffc0206728 <etext+0x136>
ffffffffc02002bc:	00006597          	auipc	a1,0x6
ffffffffc02002c0:	48c58593          	addi	a1,a1,1164 # ffffffffc0206748 <etext+0x156>
ffffffffc02002c4:	00006517          	auipc	a0,0x6
ffffffffc02002c8:	48c50513          	addi	a0,a0,1164 # ffffffffc0206750 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002d6:	48e60613          	addi	a2,a2,1166 # ffffffffc0206760 <etext+0x16e>
ffffffffc02002da:	00006597          	auipc	a1,0x6
ffffffffc02002de:	4ae58593          	addi	a1,a1,1198 # ffffffffc0206788 <etext+0x196>
ffffffffc02002e2:	00006517          	auipc	a0,0x6
ffffffffc02002e6:	46e50513          	addi	a0,a0,1134 # ffffffffc0206750 <etext+0x15e>
ffffffffc02002ea:	e97ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ee:	00006617          	auipc	a2,0x6
ffffffffc02002f2:	4aa60613          	addi	a2,a2,1194 # ffffffffc0206798 <etext+0x1a6>
ffffffffc02002f6:	00006597          	auipc	a1,0x6
ffffffffc02002fa:	4c258593          	addi	a1,a1,1218 # ffffffffc02067b8 <etext+0x1c6>
ffffffffc02002fe:	00006517          	auipc	a0,0x6
ffffffffc0200302:	45250513          	addi	a0,a0,1106 # ffffffffc0206750 <etext+0x15e>
...
ffffffffc020033c:	49050513          	addi	a0,a0,1168 # ffffffffc02067c8 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc020035e:	49650513          	addi	a0,a0,1174 # ffffffffc02067f0 <etext+0x1fe>
...
ffffffffc020037c:	4a090913          	addi	s2,s2,1184 # ffffffffc0206818 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200380:	00006497          	auipc	s1,0x6
ffffffffc0200384:	4a048493          	addi	s1,s1,1184 # ffffffffc0206820 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200388:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020038a:	00006b17          	auipc	s6,0x6
ffffffffc020038e:	49eb0b13          	addi	s6,s6,1182 # ffffffffc0206828 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc0200392:	00006a17          	auipc	s4,0x6
ffffffffc0200396:	3b6a0a13          	addi	s4,s4,950 # ffffffffc0206748 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003c0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003c2:	1d2060ef          	jal	ra,ffffffffc0206594 <strcmp>
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003d6:	1be060ef          	jal	ra,ffffffffc0206594 <strcmp>
...
ffffffffc0200414:	19e060ef          	jal	ra,ffffffffc02065b2 <strchr>
...
ffffffffc0200452:	160060ef          	jal	ra,ffffffffc02065b2 <strchr>
...
ffffffffc0200470:	3dc50513          	addi	a0,a0,988 # ffffffffc0206848 <etext+0x256>
...
ffffffffc020047e:	3d630313          	addi	t1,t1,982 # ffffffffc02b2850 <is_panic>
...
ffffffffc0200530:	32f73a23          	sd	a5,820(a4) # ffffffffc02b2860 <timebase>
...
ffffffffc0200558:	3007b223          	sd	zero,772(a5) # ffffffffc02b2858 <ticks>
    cprintf("++ setup timer interrupts\n");
...
ffffffffc0200566:	2fe7b783          	ld	a5,766(a5) # ffffffffc02b2860 <timebase>
...
ffffffffc02005fc:	19078793          	addi	a5,a5,400 # ffffffffc02a7788 <ide>
    int iobase = secno * SECTSIZE;
...
ffffffffc020060e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200610:	7cb050ef          	jal	ra,ffffffffc02065da <memcpy>
    return 0;
}
...
ffffffffc0200624:	16850513          	addi	a0,a0,360 # ffffffffc02a7788 <ide>
                   size_t nsecs) {
...
ffffffffc0200632:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200634:	7a7050ef          	jal	ra,ffffffffc02065da <memcpy>
    return 0;
}
...
ffffffffc020089e:	01e48493          	addi	s1,s1,30 # ffffffffc02b28b8 <check_mm_struct>
...
ffffffffc02008e4:	fe873703          	ld	a4,-24(a4) # ffffffffc02b28c8 <current>
ffffffffc02008e8:	000b2797          	auipc	a5,0xb2
ffffffffc02008ec:	fe87b783          	ld	a5,-24(a5) # ffffffffc02b28d0 <idleproc>
...
ffffffffc0200920:	fac7b783          	ld	a5,-84(a5) # ffffffffc02b28c8 <current>
...
ffffffffc0200a0c:	e5068693          	addi	a3,a3,-432 # ffffffffc02b2858 <ticks>
...
ffffffffc0200a24:	ea87b783          	ld	a5,-344(a5) # ffffffffc02b28c8 <current>
...
ffffffffc0200a84:	6105                	addi	sp,sp,32
            syscall();
ffffffffc0200a86:	6420506f          	j	ffffffffc02060c8 <syscall>
...
ffffffffc0200b42:	10f43423          	sd	a5,264(s0)
                syscall();
ffffffffc0200b46:	582050ef          	jal	ra,ffffffffc02060c8 <syscall>
                kernel_execve_ret(tf,current->kstack+KSTACKSIZE);
ffffffffc0200b4a:	000b2797          	auipc	a5,0xb2
ffffffffc0200b4e:	d7e7b783          	ld	a5,-642(a5) # ffffffffc02b28c8 <current>
...
ffffffffc0200c28:	ca440413          	addi	s0,s0,-860 # ffffffffc02b28c8 <current>
...
ffffffffc0200c9a:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200c9c:	3400506f          	j	ffffffffc0205fdc <schedule>
                do_exit(-E_KILLED);
ffffffffc0200ca0:	555d                	li	a0,-9
ffffffffc0200ca2:	680040ef          	jal	ra,ffffffffc0205322 <do_exit>
            if (current->need_resched) {
...
ffffffffc0200e26:	96678793          	addi	a5,a5,-1690 # ffffffffc02ae788 <free_area>
...
ffffffffc0200e38:	96456503          	lwu	a0,-1692(a0) # ffffffffc02ae798 <free_area+0x10>
...
ffffffffc0200e46:	94640413          	addi	s0,s0,-1722 # ffffffffc02ae788 <free_area>
...
ffffffffc0200f28:	8607aa23          	sw	zero,-1932(a5) # ffffffffc02ae798 <free_area+0x10>
    assert(alloc_page() == NULL);
...
ffffffffc020100a:	7807a923          	sw	zero,1938(a5) # ffffffffc02ae798 <free_area+0x10>
    free_pages(p0 + 2, 3);
...
ffffffffc0201606:	18668693          	addi	a3,a3,390 # ffffffffc02ae788 <free_area>
...
ffffffffc0201732:	05a58593          	addi	a1,a1,90 # ffffffffc02ae788 <free_area>
...
ffffffffc020181e:	f6e68693          	addi	a3,a3,-146 # ffffffffc02ae788 <free_area>
...
ffffffffc02018ea:	a9260613          	addi	a2,a2,-1390 # ffffffffc02a7378 <slobfree>
...
ffffffffc0201998:	ef46b683          	ld	a3,-268(a3) # ffffffffc02b2888 <pages>
ffffffffc020199c:	8d15                	sub	a0,a0,a3
ffffffffc020199e:	8519                	srai	a0,a0,0x6
ffffffffc02019a0:	00007697          	auipc	a3,0x7
ffffffffc02019a4:	3386b683          	ld	a3,824(a3) # ffffffffc0208cd8 <nbase>
...
ffffffffc02019b4:	ed073703          	ld	a4,-304(a4) # ffffffffc02b2880 <npage>
    return page2ppn(page) << PGSHIFT;
...
ffffffffc02019c2:	eda6b683          	ld	a3,-294(a3) # ffffffffc02b2898 <va_pa_offset>
...
ffffffffc0201a10:	96c90913          	addi	s2,s2,-1684 # ffffffffc02a7378 <slobfree>
...
ffffffffc0201b4e:	d1e78793          	addi	a5,a5,-738 # ffffffffc02b2868 <bigblocks>
...
ffffffffc0201b8a:	ce278793          	addi	a5,a5,-798 # ffffffffc02b2868 <bigblocks>
...
ffffffffc0201bd0:	c9c7b783          	ld	a5,-868(a5) # ffffffffc02b2868 <bigblocks>
    return 0;
...
ffffffffc0201bdc:	c9068693          	addi	a3,a3,-880 # ffffffffc02b2868 <bigblocks>
...
ffffffffc0201c60:	c0c7b783          	ld	a5,-1012(a5) # ffffffffc02b2868 <bigblocks>
        return 1;
...
ffffffffc0201cf8:	b9c90913          	addi	s2,s2,-1124 # ffffffffc02b2890 <pmm_manager>
        {
...
ffffffffc0201d02:	bb2a8a93          	addi	s5,s5,-1102 # ffffffffc02b28b0 <swap_init_ok>
...
ffffffffc0201d0e:	baeb0b13          	addi	s6,s6,-1106 # ffffffffc02b28b8 <check_mm_struct>
...
ffffffffc0201d7e:	b167b783          	ld	a5,-1258(a5) # ffffffffc02b2890 <pmm_manager>
...
ffffffffc0201d9a:	afa7b783          	ld	a5,-1286(a5) # ffffffffc02b2890 <pmm_manager>
...
ffffffffc0201dbe:	ad67b783          	ld	a5,-1322(a5) # ffffffffc02b2890 <pmm_manager>
...
ffffffffc0201dd4:	ac07b783          	ld	a5,-1344(a5) # ffffffffc02b2890 <pmm_manager>
...
ffffffffc0201e1a:	a6aa0a13          	addi	s4,s4,-1430 # ffffffffc02b2880 <npage>
    if (!(*pdep1 & PTE_V)) {
...
ffffffffc0201e34:	a58b0b13          	addi	s6,s6,-1448 # ffffffffc02b2888 <pages>
...
ffffffffc0201e44:	a40a0a13          	addi	s4,s4,-1472 # ffffffffc02b2880 <npage>
...
ffffffffc0201e68:	a347b783          	ld	a5,-1484(a5) # ffffffffc02b2898 <va_pa_offset>
ffffffffc0201e6c:	6605                	lui	a2,0x1
ffffffffc0201e6e:	4581                	li	a1,0
ffffffffc0201e70:	953e                	add	a0,a0,a5
ffffffffc0201e72:	756040ef          	jal	ra,ffffffffc02065c8 <memset>
    return page - pages + nbase;
...
ffffffffc0201ea0:	9fca8a93          	addi	s5,s5,-1540 # ffffffffc02b2898 <va_pa_offset>
...
ffffffffc0201ed2:	9bab0b13          	addi	s6,s6,-1606 # ffffffffc02b2888 <pages>
...
ffffffffc0201f04:	6c4040ef          	jal	ra,ffffffffc02065c8 <memset>
    return page - pages + nbase;
...
ffffffffc0201fec:	89873703          	ld	a4,-1896(a4) # ffffffffc02b2880 <npage>
...
ffffffffc0202004:	88853503          	ld	a0,-1912(a0) # ffffffffc02b2888 <pages>
...
ffffffffc0202054:	830c8c93          	addi	s9,s9,-2000 # ffffffffc02b2880 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc0202058:	000b1c17          	auipc	s8,0xb1
ffffffffc020205c:	830c0c13          	addi	s8,s8,-2000 # ffffffffc02b2888 <pages>
ffffffffc0202060:	fff80bb7          	lui	s7,0xfff80
        pmm_manager->free_pages(base, n);
ffffffffc0202064:	000b1d17          	auipc	s10,0xb1
ffffffffc0202068:	82cd0d13          	addi	s10,s10,-2004 # ffffffffc02b2890 <pmm_manager>
...
ffffffffc02021b2:	6d2d0d13          	addi	s10,s10,1746 # ffffffffc02b2880 <npage>
    return KADDR(page2pa(page));
ffffffffc02021b6:	00ccdc93          	srli	s9,s9,0xc
    return &pages[PPN(pa) - nbase];
ffffffffc02021ba:	000b0717          	auipc	a4,0xb0
ffffffffc02021be:	6ce70713          	addi	a4,a4,1742 # ffffffffc02b2888 <pages>
        pmm_manager->free_pages(base, n);
ffffffffc02021c2:	000b0d97          	auipc	s11,0xb0
ffffffffc02021c6:	6ced8d93          	addi	s11,s11,1742 # ffffffffc02b2890 <pmm_manager>
...
ffffffffc0202222:	67a80813          	addi	a6,a6,1658 # ffffffffc02b2898 <va_pa_offset>
...
ffffffffc02022b6:	5e680813          	addi	a6,a6,1510 # ffffffffc02b2898 <va_pa_offset>
...
ffffffffc02022c8:	5c470713          	addi	a4,a4,1476 # ffffffffc02b2888 <pages>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202300:	58c70713          	addi	a4,a4,1420 # ffffffffc02b2888 <pages>
...
ffffffffc020234e:	53e70713          	addi	a4,a4,1342 # ffffffffc02b2888 <pages>
...
ffffffffc0202360:	53c80813          	addi	a6,a6,1340 # ffffffffc02b2898 <va_pa_offset>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202384:	50870713          	addi	a4,a4,1288 # ffffffffc02b2888 <pages>
                pgdir[PDX1(d1start)] = 0;
...
ffffffffc0202418:	46c73703          	ld	a4,1132(a4) # ffffffffc02b2880 <npage>
...
ffffffffc020242c:	46053503          	ld	a0,1120(a0) # ffffffffc02b2888 <pages>
...
ffffffffc020245a:	43a7b783          	ld	a5,1082(a5) # ffffffffc02b2890 <pmm_manager>
...
ffffffffc0202470:	4247b783          	ld	a5,1060(a5) # ffffffffc02b2890 <pmm_manager>
...
ffffffffc02024bc:	3d073703          	ld	a4,976(a4) # ffffffffc02b2888 <pages>
...
ffffffffc02024f6:	38e73703          	ld	a4,910(a4) # ffffffffc02b2880 <npage>
ffffffffc02024fa:	06e7ff63          	bgeu	a5,a4,ffffffffc0202578 <page_insert+0xf2>
    return &pages[PPN(pa) - nbase];
ffffffffc02024fe:	000b0a97          	auipc	s5,0xb0
ffffffffc0202502:	38aa8a93          	addi	s5,s5,906 # ffffffffc02b2888 <pages>
...
ffffffffc0202514:	01240c63          	beq	s0,s2,ffffffffc020252c <page_insert+0xa6>
    page->ref -= 1;
ffffffffc0202518:	00092783          	lw	a5,0(s2) # fffffffffff80000 <end+0x3fccd71c>
...
ffffffffc020253c:	3587b783          	ld	a5,856(a5) # ffffffffc02b2890 <pmm_manager>
...
ffffffffc020255a:	33a7b783          	ld	a5,826(a5) # ffffffffc02b2890 <pmm_manager>
...
ffffffffc0202596:	2feb8b93          	addi	s7,s7,766 # ffffffffc02b2890 <pmm_manager>
void pmm_init(void) {
...
ffffffffc02025bc:	2e098993          	addi	s3,s3,736 # ffffffffc02b2898 <va_pa_offset>
    npage = maxpa / PGSIZE;
ffffffffc02025c0:	000b0497          	auipc	s1,0xb0
ffffffffc02025c4:	2c048493          	addi	s1,s1,704 # ffffffffc02b2880 <npage>
    pmm_manager->init();
ffffffffc02025c8:	679c                	ld	a5,8(a5)
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc02025ca:	000b0b17          	auipc	s6,0xb0
ffffffffc02025ce:	2beb0b13          	addi	s6,s6,702 # ffffffffc02b2888 <pages>
    pmm_manager->init();
...
ffffffffc020260a:	2dd78793          	addi	a5,a5,733 # ffffffffc02b38e3 <end+0xfff>
...
ffffffffc0202674:	20890913          	addi	s2,s2,520 # ffffffffc02b2878 <boot_pgdir>
    pmm_manager->check();
...
ffffffffc02026a6:	1cd7b723          	sd	a3,462(a5) # ffffffffc02b2870 <boot_cr3>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc02028fc:	0007b023          	sd	zero,0(a5) # fffffffffff80000 <end+0x3fccd71c>
  asm volatile("sfence.vma");
...
ffffffffc02029a4:	62051d63          	bnez	a0,ffffffffc0202fde <pmm_init+0xa62>
    assert(page_ref(p) == 1);
ffffffffc02029a8:	000aa703          	lw	a4,0(s5) # fffffffffffff000 <end+0x3fd4c71c>
...
ffffffffc02029de:	3a5030ef          	jal	ra,ffffffffc0206582 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02029e2:	10040593          	addi	a1,s0,256
ffffffffc02029e6:	10000513          	li	a0,256
ffffffffc02029ea:	3ab030ef          	jal	ra,ffffffffc0206594 <strcmp>
...
ffffffffc0202a1c:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a20:	32d030ef          	jal	ra,ffffffffc020654c <strlen>
...
ffffffffc0203160:	724c8c93          	addi	s9,s9,1828 # ffffffffc02b2880 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc0203164:	000afc17          	auipc	s8,0xaf
ffffffffc0203168:	724c0c13          	addi	s8,s8,1828 # ffffffffc02b2888 <pages>
    return page - pages + nbase;
...
ffffffffc0203216:	68670713          	addi	a4,a4,1670 # ffffffffc02b2898 <va_pa_offset>
...
ffffffffc0203232:	3a8030ef          	jal	ra,ffffffffc02065da <memcpy>
...
ffffffffc020337a:	53a7a783          	lw	a5,1338(a5) # ffffffffc02b28b0 <swap_init_ok>
ffffffffc020337e:	c385                	beqz	a5,ffffffffc020339e <pgdir_alloc_page+0x52>
            if (check_mm_struct != NULL) {
ffffffffc0203380:	000af517          	auipc	a0,0xaf
ffffffffc0203384:	53853503          	ld	a0,1336(a0) # ffffffffc02b28b8 <check_mm_struct>
...
ffffffffc02033ba:	4da7b783          	ld	a5,1242(a5) # ffffffffc02b2890 <pmm_manager>
...
ffffffffc02033d2:	4c27b783          	ld	a5,1218(a5) # ffffffffc02b2890 <pmm_manager>
...
ffffffffc020343c:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc020343e:	776010ef          	jal	ra,ffffffffc0204bb4 <swapfs_init>

     // Since the IDE is faked, it can only store 7 pages at most to pass the test
     if (!(7 <= max_swap_offset &&
ffffffffc0203442:	000af697          	auipc	a3,0xaf
ffffffffc0203446:	45e6b683          	ld	a3,1118(a3) # ffffffffc02b28a0 <max_swap_offset>
...
ffffffffc020345c:	ee078793          	addi	a5,a5,-288 # ffffffffc02a7338 <swap_manager_fifo>
     int r = sm->init();
ffffffffc0203460:	6798                	ld	a4,8(a5)
     sm = &swap_manager_fifo;
ffffffffc0203462:	000afb97          	auipc	s7,0xaf
ffffffffc0203466:	446b8b93          	addi	s7,s7,1094 # ffffffffc02b28a8 <sm>
...
ffffffffc02034a4:	2e840413          	addi	s0,s0,744 # ffffffffc02ae788 <free_area>
ffffffffc02034a8:	638c                	ld	a1,0(a5)
          swap_init_ok = 1;
ffffffffc02034aa:	4785                	li	a5,1
ffffffffc02034ac:	000af717          	auipc	a4,0xaf
ffffffffc02034b0:	40f72223          	sw	a5,1028(a4) # ffffffffc02b28b0 <swap_init_ok>
          cprintf("SWAP: manager = %s\n", sm->name);
...
ffffffffc0203504:	3b878793          	addi	a5,a5,952 # ffffffffc02b28b8 <check_mm_struct>
...
ffffffffc0203512:	36a70713          	addi	a4,a4,874 # ffffffffc02b2878 <boot_pgdir>
...
ffffffffc0203566:	25e48493          	addi	s1,s1,606 # ffffffffc02ae7c0 <check_rp>
ffffffffc020356a:	c17fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
     
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc020356e:	000ab997          	auipc	s3,0xab
ffffffffc0203572:	27298993          	addi	s3,s3,626 # ffffffffc02ae7e0 <swap_in_seq_no>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
...
ffffffffc020359a:	22aa0a13          	addi	s4,s4,554 # ffffffffc02ae7c0 <check_rp>
    elm->prev = elm->next = elm;
...
ffffffffc02035b0:	1e07a623          	sw	zero,492(a5) # ffffffffc02ae798 <free_area+0x10>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
...
ffffffffc02035e0:	2e07a223          	sw	zero,740(a5) # ffffffffc02b28c0 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02035ee:	2d66a683          	lw	a3,726(a3) # ffffffffc02b28c0 <pgfault_num>
ffffffffc02035f2:	4585                	li	a1,1
ffffffffc02035f4:	000af797          	auipc	a5,0xaf
ffffffffc02035f8:	2cc78793          	addi	a5,a5,716 # ffffffffc02b28c0 <pgfault_num>
...
ffffffffc020366e:	17678793          	addi	a5,a5,374 # ffffffffc02ae7e0 <swap_in_seq_no>
ffffffffc0203672:	000ab717          	auipc	a4,0xab
ffffffffc0203676:	19670713          	addi	a4,a4,406 # ffffffffc02ae808 <swap_out_seq_no>
ffffffffc020367a:	000ab617          	auipc	a2,0xab
ffffffffc020367e:	18e60613          	addi	a2,a2,398 # ffffffffc02ae808 <swap_out_seq_no>
...
ffffffffc0203694:	11070713          	addi	a4,a4,272 # ffffffffc02ae7a0 <check_ptep>
ffffffffc0203698:	000ab697          	auipc	a3,0xab
ffffffffc020369c:	12868693          	addi	a3,a3,296 # ffffffffc02ae7c0 <check_rp>
ffffffffc02036a0:	6585                	lui	a1,0x1
    if (PPN(pa) >= npage) {
ffffffffc02036a2:	000afc17          	auipc	s8,0xaf
ffffffffc02036a6:	1dec0c13          	addi	s8,s8,478 # ffffffffc02b2880 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02036aa:	000afc97          	auipc	s9,0xaf
ffffffffc02036ae:	1dec8c93          	addi	s9,s9,478 # ffffffffc02b2888 <pages>
...
ffffffffc02036ea:	5f260613          	addi	a2,a2,1522 # ffffffffc0208cd8 <nbase>
...
ffffffffc0203752:	12a78793          	addi	a5,a5,298 # ffffffffc02b2878 <boot_pgdir>
ffffffffc0203756:	639c                	ld	a5,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0203758:	000c3703          	ld	a4,0(s8)
     check_mm_struct = NULL;
ffffffffc020375c:	000af697          	auipc	a3,0xaf
ffffffffc0203760:	1406be23          	sd	zero,348(a3) # ffffffffc02b28b8 <check_mm_struct>
    return pa2page(PDE_ADDR(pde));
...
ffffffffc020378c:	1107b783          	ld	a5,272(a5) # ffffffffc02b2898 <va_pa_offset>
...
ffffffffc0203b6c:	d407b783          	ld	a5,-704(a5) # ffffffffc02b28a8 <sm>
...
ffffffffc0203b78:	d347b783          	ld	a5,-716(a5) # ffffffffc02b28a8 <sm>
...
ffffffffc0203ba4:	d0898993          	addi	s3,s3,-760 # ffffffffc02b28a8 <sm>
...
ffffffffc0203c24:	056010ef          	jal	ra,ffffffffc0204c7a <swapfs_write>
...
ffffffffc0203cc2:	72b000ef          	jal	ra,ffffffffc0204bec <swapfs_read>
...
ffffffffc0203d12:	b2278793          	addi	a5,a5,-1246 # ffffffffc02ae830 <pra_list_head>
 */
static int
...
ffffffffc0203d5e:	b6692903          	lw	s2,-1178(s2) # ffffffffc02b28c0 <pgfault_num>
...
ffffffffc0203d7c:	b4840413          	addi	s0,s0,-1208 # ffffffffc02b28c0 <pgfault_num>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0204146:	76e7a783          	lw	a5,1902(a5) # ffffffffc02b28b0 <swap_init_ok>
...
ffffffffc0204572:	fe87b683          	ld	a3,-24(a5) # ffffffffffffefe8 <end+0x3fd4c704>
...
ffffffffc020466c:	24a7b823          	sd	a0,592(a5) # ffffffffc02b28b8 <check_mm_struct>
...
ffffffffc020467a:	2024b483          	ld	s1,514(s1) # ffffffffc02b2878 <boot_pgdir>
    assert(pgdir[0] == 0);
...
ffffffffc02046f2:	192a8a93          	addi	s5,s5,402 # ffffffffc02b2880 <npage>
...
ffffffffc0204706:	5d6a3a03          	ld	s4,1494(s4) # ffffffffc0208cd8 <nbase>
...
ffffffffc0204726:	1769b983          	ld	s3,374(s3) # ffffffffc02b2898 <va_pa_offset>
...
ffffffffc0204748:	14498993          	addi	s3,s3,324 # ffffffffc02b2888 <pages>
...
ffffffffc0204794:	1207b423          	sd	zero,296(a5) # ffffffffc02b28b8 <check_mm_struct>
...
ffffffffc02049fe:	f04a                	sd	s2,32(sp)
ffffffffc0204a00:	fc06                	sd	ra,56(sp)
ffffffffc0204a02:	f426                	sd	s1,40(sp)
...
ffffffffc0204a12:	eb27a783          	lw	a5,-334(a5) # ffffffffc02b28c0 <pgfault_num>
ffffffffc0204a16:	2785                	addiw	a5,a5,1
ffffffffc0204a18:	000ae717          	auipc	a4,0xae
ffffffffc0204a1c:	eaf72423          	sw	a5,-344(a4) # ffffffffc02b28c0 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0204a20:	c579                	beqz	a0,ffffffffc0204aee <do_pgfault+0xf6>
ffffffffc0204a22:	651c                	ld	a5,8(a0)
ffffffffc0204a24:	0cf46563          	bltu	s0,a5,ffffffffc0204aee <do_pgfault+0xf6>
...
ffffffffc0204a2e:	e3b5                	bnez	a5,ffffffffc0204a92 <do_pgfault+0x9a>
        perm |= READ_WRITE;
    }
...
ffffffffc0204a32:	01893503          	ld	a0,24(s2)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0204a36:	8c6d                	and	s0,s0,a1
    if ((ptep = get_pte(mm->pgdir, addr, 1)) == NULL) {
ffffffffc0204a38:	4605                	li	a2,1
ffffffffc0204a3a:	85a2                	mv	a1,s0
ffffffffc0204a3c:	bb0fd0ef          	jal	ra,ffffffffc0201dec <get_pte>
ffffffffc0204a40:	c961                	beqz	a0,ffffffffc0204b10 <do_pgfault+0x118>
        cprintf("get_pte in do_pgfault failed\n");
        goto failed;
    }
    
    if (*ptep == 0) { // if the phy addr isn't exist, then alloc a page & map the phy addr with logical addr
ffffffffc0204a42:	610c                	ld	a1,0(a0)
ffffffffc0204a44:	c5bd                	beqz	a1,ffffffffc0204ab2 <do_pgfault+0xba>
        ...
        */
        ...
        if (swap_init_ok) {
ffffffffc0204a46:	000ae797          	auipc	a5,0xae
ffffffffc0204a4a:	e6a7a783          	lw	a5,-406(a5) # ffffffffc02b28b0 <swap_init_ok>
ffffffffc0204a4e:	cbcd                	beqz	a5,ffffffffc0204b00 <do_pgfault+0x108>
...
ffffffffc0204a50:	0030                	addi	a2,sp,8
ffffffffc0204a52:	85a2                	mv	a1,s0
ffffffffc0204a54:	854a                	mv	a0,s2
            struct Page *page = NULL;
ffffffffc0204a56:	e402                	sd	zero,8(sp)
            if((ret = swap_in(mm, addr, &page)) != 0){
ffffffffc0204a58:	a3cff0ef          	jal	ra,ffffffffc0203c94 <swap_in>
ffffffffc0204a5c:	84aa                	mv	s1,a0
ffffffffc0204a5e:	ed05                	bnez	a0,ffffffffc0204a96 <do_pgfault+0x9e>
                cprintf("swap_in failed\n");
                goto failed;
            }
            if((ret = page_insert(mm -> pgdir, page, addr, perm)) != 0){
ffffffffc0204a60:	65a2                	ld	a1,8(sp)
ffffffffc0204a62:	01893503          	ld	a0,24(s2)
ffffffffc0204a66:	86ce                	mv	a3,s3
ffffffffc0204a68:	8622                	mv	a2,s0
ffffffffc0204a6a:	a1dfd0ef          	jal	ra,ffffffffc0202486 <page_insert>
ffffffffc0204a6e:	84aa                	mv	s1,a0
ffffffffc0204a70:	e12d                	bnez	a0,ffffffffc0204ad2 <do_pgfault+0xda>
                cprintf("page_insert failed\n");
                goto failed;
            }
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0204a72:	6622                	ld	a2,8(sp)
ffffffffc0204a74:	4685                	li	a3,1
ffffffffc0204a76:	85a2                	mv	a1,s0
ffffffffc0204a78:	854a                	mv	a0,s2
ffffffffc0204a7a:	8faff0ef          	jal	ra,ffffffffc0203b74 <swap_map_swappable>

            page->pra_vaddr = addr;
ffffffffc0204a7e:	67a2                	ld	a5,8(sp)
ffffffffc0204a80:	ff80                	sd	s0,56(a5)
        }
   }
   ret = 0;
failed:
...
ffffffffc0204a82:	70e2                	ld	ra,56(sp)
ffffffffc0204a84:	7442                	ld	s0,48(sp)
ffffffffc0204a86:	7902                	ld	s2,32(sp)
ffffffffc0204a88:	69e2                	ld	s3,24(sp)
ffffffffc0204a8a:	8526                	mv	a0,s1
ffffffffc0204a8c:	74a2                	ld	s1,40(sp)
ffffffffc0204a8e:	6121                	addi	sp,sp,64
ffffffffc0204a90:	8082                	ret
        perm |= READ_WRITE;
ffffffffc0204a92:	49dd                	li	s3,23
ffffffffc0204a94:	bf71                	j	ffffffffc0204a30 <do_pgfault+0x38>
                cprintf("swap_in failed\n");
ffffffffc0204a96:	00004517          	auipc	a0,0x4
ffffffffc0204a9a:	89a50513          	addi	a0,a0,-1894 # ffffffffc0208330 <default_pmm_manager+0xfe8>
ffffffffc0204a9e:	ee2fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
}
ffffffffc0204aa2:	70e2                	ld	ra,56(sp)
ffffffffc0204aa4:	7442                	ld	s0,48(sp)
ffffffffc0204aa6:	7902                	ld	s2,32(sp)
ffffffffc0204aa8:	69e2                	ld	s3,24(sp)
ffffffffc0204aaa:	8526                	mv	a0,s1
ffffffffc0204aac:	74a2                	ld	s1,40(sp)
ffffffffc0204aae:	6121                	addi	sp,sp,64
ffffffffc0204ab0:	8082                	ret
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204ab2:	01893503          	ld	a0,24(s2)
ffffffffc0204ab6:	864e                	mv	a2,s3
ffffffffc0204ab8:	85a2                	mv	a1,s0
ffffffffc0204aba:	893fe0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
   ret = 0;
ffffffffc0204abe:	4481                	li	s1,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204ac0:	f169                	bnez	a0,ffffffffc0204a82 <do_pgfault+0x8a>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0204ac2:	00004517          	auipc	a0,0x4
ffffffffc0204ac6:	84650513          	addi	a0,a0,-1978 # ffffffffc0208308 <default_pmm_manager+0xfc0>
ffffffffc0204aca:	eb6fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204ace:	54f1                	li	s1,-4
            goto failed;
ffffffffc0204ad0:	bf4d                	j	ffffffffc0204a82 <do_pgfault+0x8a>
                cprintf("page_insert failed\n");
ffffffffc0204ad2:	00004517          	auipc	a0,0x4
ffffffffc0204ad6:	86e50513          	addi	a0,a0,-1938 # ffffffffc0208340 <default_pmm_manager+0xff8>
ffffffffc0204ada:	ea6fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
}
ffffffffc0204ade:	70e2                	ld	ra,56(sp)
ffffffffc0204ae0:	7442                	ld	s0,48(sp)
ffffffffc0204ae2:	7902                	ld	s2,32(sp)
ffffffffc0204ae4:	69e2                	ld	s3,24(sp)
ffffffffc0204ae6:	8526                	mv	a0,s1
ffffffffc0204ae8:	74a2                	ld	s1,40(sp)
ffffffffc0204aea:	6121                	addi	sp,sp,64
ffffffffc0204aec:	8082                	ret
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0204aee:	85a2                	mv	a1,s0
ffffffffc0204af0:	00003517          	auipc	a0,0x3
ffffffffc0204af4:	7c850513          	addi	a0,a0,1992 # ffffffffc02082b8 <default_pmm_manager+0xf70>
ffffffffc0204af8:	e88fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    int ret = -E_INVAL;
ffffffffc0204afc:	54f5                	li	s1,-3
        goto failed;
ffffffffc0204afe:	b751                	j	ffffffffc0204a82 <do_pgfault+0x8a>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0204b00:	00004517          	auipc	a0,0x4
ffffffffc0204b04:	85850513          	addi	a0,a0,-1960 # ffffffffc0208358 <default_pmm_manager+0x1010>
ffffffffc0204b08:	e78fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204b0c:	54f1                	li	s1,-4
            goto failed;
ffffffffc0204b0e:	bf95                	j	ffffffffc0204a82 <do_pgfault+0x8a>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc0204b10:	00003517          	auipc	a0,0x3
ffffffffc0204b14:	7d850513          	addi	a0,a0,2008 # ffffffffc02082e8 <default_pmm_manager+0xfa0>
ffffffffc0204b18:	e68fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204b1c:	54f1                	li	s1,-4
        goto failed;
ffffffffc0204b1e:	b795                	j	ffffffffc0204a82 <do_pgfault+0x8a>

ffffffffc0204b20 <user_mem_check>:

bool
user_mem_check(struct mm_struct *mm, uintptr_t addr, size_t len, bool write) {
ffffffffc0204b20:	7179                	addi	sp,sp,-48
ffffffffc0204b22:	f022                	sd	s0,32(sp)
ffffffffc0204b24:	f406                	sd	ra,40(sp)
ffffffffc0204b26:	ec26                	sd	s1,24(sp)
ffffffffc0204b28:	e84a                	sd	s2,16(sp)
ffffffffc0204b2a:	e44e                	sd	s3,8(sp)
ffffffffc0204b2c:	e052                	sd	s4,0(sp)
ffffffffc0204b2e:	842e                	mv	s0,a1
    if (mm != NULL) {
ffffffffc0204b30:	c135                	beqz	a0,ffffffffc0204b94 <user_mem_check+0x74>
        if (!USER_ACCESS(addr, addr + len)) {
ffffffffc0204b32:	002007b7          	lui	a5,0x200
ffffffffc0204b36:	04f5e663          	bltu	a1,a5,ffffffffc0204b82 <user_mem_check+0x62>
ffffffffc0204b3a:	00c584b3          	add	s1,a1,a2
ffffffffc0204b3e:	0495f263          	bgeu	a1,s1,ffffffffc0204b82 <user_mem_check+0x62>
ffffffffc0204b42:	4785                	li	a5,1
ffffffffc0204b44:	07fe                	slli	a5,a5,0x1f
ffffffffc0204b46:	0297ee63          	bltu	a5,s1,ffffffffc0204b82 <user_mem_check+0x62>
ffffffffc0204b4a:	892a                	mv	s2,a0
ffffffffc0204b4c:	89b6                	mv	s3,a3
            }
...
ffffffffc0204b4e:	6a05                	lui	s4,0x1
ffffffffc0204b50:	a821                	j	ffffffffc0204b68 <user_mem_check+0x48>
            if (!(vma->vm_flags & ((write) ? VM_WRITE : VM_READ))) {
ffffffffc0204b52:	0027f693          	andi	a3,a5,2
                if (start < vma->vm_start + PGSIZE) { //check stack start & size
ffffffffc0204b56:	9752                	add	a4,a4,s4
            if (write && (vma->vm_flags & VM_STACK)) {
ffffffffc0204b58:	8ba1                	andi	a5,a5,8
            if (!(vma->vm_flags & ((write) ? VM_WRITE : VM_READ))) {
ffffffffc0204b5a:	c685                	beqz	a3,ffffffffc0204b82 <user_mem_check+0x62>
            if (write && (vma->vm_flags & VM_STACK)) {
ffffffffc0204b5c:	c399                	beqz	a5,ffffffffc0204b62 <user_mem_check+0x42>
                if (start < vma->vm_start + PGSIZE) { //check stack start & size
ffffffffc0204b5e:	02e46263          	bltu	s0,a4,ffffffffc0204b82 <user_mem_check+0x62>
                    return 0;
                }
            }
            start = vma->vm_end;
ffffffffc0204b62:	6900                	ld	s0,16(a0)
        while (start < end) {
ffffffffc0204b64:	04947663          	bgeu	s0,s1,ffffffffc0204bb0 <user_mem_check+0x90>
            if ((vma = find_vma(mm, start)) == NULL || start < vma->vm_start) {
ffffffffc0204b68:	85a2                	mv	a1,s0
ffffffffc0204b6a:	854a                	mv	a0,s2
ffffffffc0204b6c:	e2aff0ef          	jal	ra,ffffffffc0204196 <find_vma>
ffffffffc0204b70:	c909                	beqz	a0,ffffffffc0204b82 <user_mem_check+0x62>
ffffffffc0204b72:	6518                	ld	a4,8(a0)
ffffffffc0204b74:	00e46763          	bltu	s0,a4,ffffffffc0204b82 <user_mem_check+0x62>
            if (!(vma->vm_flags & ((write) ? VM_WRITE : VM_READ))) {
ffffffffc0204b78:	4d1c                	lw	a5,24(a0)
ffffffffc0204b7a:	fc099ce3          	bnez	s3,ffffffffc0204b52 <user_mem_check+0x32>
ffffffffc0204b7e:	8b85                	andi	a5,a5,1
ffffffffc0204b80:	f3ed                	bnez	a5,ffffffffc0204b62 <user_mem_check+0x42>
            return 0;
...
ffffffffc0204b84:	70a2                	ld	ra,40(sp)
ffffffffc0204b86:	7402                	ld	s0,32(sp)
...
ffffffffc0204b90:	6145                	addi	sp,sp,48
ffffffffc0204b92:	8082                	ret
    return KERN_ACCESS(addr, addr + len);
ffffffffc0204b94:	c02007b7          	lui	a5,0xc0200
ffffffffc0204b98:	4501                	li	a0,0
ffffffffc0204b9a:	fef5e5e3          	bltu	a1,a5,ffffffffc0204b84 <user_mem_check+0x64>
ffffffffc0204b9e:	962e                	add	a2,a2,a1
ffffffffc0204ba0:	fec5f2e3          	bgeu	a1,a2,ffffffffc0204b84 <user_mem_check+0x64>
ffffffffc0204ba4:	c8000537          	lui	a0,0xc8000
ffffffffc0204ba8:	0505                	addi	a0,a0,1
ffffffffc0204baa:	00a63533          	sltu	a0,a2,a0
ffffffffc0204bae:	bfd9                	j	ffffffffc0204b84 <user_mem_check+0x64>
        return 1;
ffffffffc0204bb0:	4505                	li	a0,1
ffffffffc0204bb2:	bfc9                	j	ffffffffc0204b84 <user_mem_check+0x64>

ffffffffc0204bb4 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0204bb6:	4505                	li	a0,1
swapfs_init(void) {
ffffffffc0204bb8:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0204bba:	a33fb0ef          	jal	ra,ffffffffc02005ec <ide_device_valid>
ffffffffc0204bbe:	cd01                	beqz	a0,ffffffffc0204bd6 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0204bc0:	4505                	li	a0,1
ffffffffc0204bc2:	a31fb0ef          	jal	ra,ffffffffc02005f2 <ide_device_size>
}
ffffffffc0204bc6:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0204bc8:	810d                	srli	a0,a0,0x3
ffffffffc0204bca:	000ae797          	auipc	a5,0xae
ffffffffc0204bce:	cca7bb23          	sd	a0,-810(a5) # ffffffffc02b28a0 <max_swap_offset>
}
ffffffffc0204bd2:	0141                	addi	sp,sp,16
ffffffffc0204bd4:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204bd6:	00003617          	auipc	a2,0x3
ffffffffc0204bda:	7aa60613          	addi	a2,a2,1962 # ffffffffc0208380 <default_pmm_manager+0x1038>
ffffffffc0204bde:	45b5                	li	a1,13
ffffffffc0204be0:	00003517          	auipc	a0,0x3
ffffffffc0204be4:	7c050513          	addi	a0,a0,1984 # ffffffffc02083a0 <default_pmm_manager+0x1058>
ffffffffc0204be8:	893fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204bec <swapfs_read>:

int
swapfs_read(swap_entry_t entry, struct Page *page) {
ffffffffc0204bec:	1141                	addi	sp,sp,-16
ffffffffc0204bee:	e406                	sd	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204bf0:	00855793          	srli	a5,a0,0x8
ffffffffc0204bf4:	cbb1                	beqz	a5,ffffffffc0204c48 <swapfs_read+0x5c>
ffffffffc0204bf6:	000ae717          	auipc	a4,0xae
ffffffffc0204bfa:	caa73703          	ld	a4,-854(a4) # ffffffffc02b28a0 <max_swap_offset>
ffffffffc0204bfe:	04e7f563          	bgeu	a5,a4,ffffffffc0204c48 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc0204c02:	000ae617          	auipc	a2,0xae
ffffffffc0204c06:	c8663603          	ld	a2,-890(a2) # ffffffffc02b2888 <pages>
ffffffffc0204c0a:	8d91                	sub	a1,a1,a2
ffffffffc0204c0c:	4065d613          	srai	a2,a1,0x6
ffffffffc0204c10:	00004717          	auipc	a4,0x4
ffffffffc0204c14:	0c873703          	ld	a4,200(a4) # ffffffffc0208cd8 <nbase>
ffffffffc0204c18:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc0204c1a:	00c61713          	slli	a4,a2,0xc
ffffffffc0204c1e:	8331                	srli	a4,a4,0xc
ffffffffc0204c20:	000ae697          	auipc	a3,0xae
ffffffffc0204c24:	c606b683          	ld	a3,-928(a3) # ffffffffc02b2880 <npage>
ffffffffc0204c28:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204c2c:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc0204c2e:	02d77963          	bgeu	a4,a3,ffffffffc0204c60 <swapfs_read+0x74>
}
ffffffffc0204c32:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204c34:	000ae797          	auipc	a5,0xae
ffffffffc0204c38:	c647b783          	ld	a5,-924(a5) # ffffffffc02b2898 <va_pa_offset>
...
ffffffffc0204c42:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204c44:	9b5fb06f          	j	ffffffffc02005f8 <ide_read_secs>
ffffffffc0204c48:	86aa                	mv	a3,a0
ffffffffc0204c4a:	00003617          	auipc	a2,0x3
ffffffffc0204c4e:	76e60613          	addi	a2,a2,1902 # ffffffffc02083b8 <default_pmm_manager+0x1070>
ffffffffc0204c52:	45d1                	li	a1,20
ffffffffc0204c54:	00003517          	auipc	a0,0x3
ffffffffc0204c58:	74c50513          	addi	a0,a0,1868 # ffffffffc02083a0 <default_pmm_manager+0x1058>
...
ffffffffc0204c6a:	71a60613          	addi	a2,a2,1818 # ffffffffc0207380 <default_pmm_manager+0x38>
ffffffffc0204c6e:	00002517          	auipc	a0,0x2
ffffffffc0204c72:	73a50513          	addi	a0,a0,1850 # ffffffffc02073a8 <default_pmm_manager+0x60>
ffffffffc0204c76:	805fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204c7a <swapfs_write>:

int
swapfs_write(swap_entry_t entry, struct Page *page) {
ffffffffc0204c7a:	1141                	addi	sp,sp,-16
ffffffffc0204c7c:	e406                	sd	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204c7e:	00855793          	srli	a5,a0,0x8
ffffffffc0204c82:	cbb1                	beqz	a5,ffffffffc0204cd6 <swapfs_write+0x5c>
ffffffffc0204c84:	000ae717          	auipc	a4,0xae
ffffffffc0204c88:	c1c73703          	ld	a4,-996(a4) # ffffffffc02b28a0 <max_swap_offset>
ffffffffc0204c8c:	04e7f563          	bgeu	a5,a4,ffffffffc0204cd6 <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc0204c90:	000ae617          	auipc	a2,0xae
ffffffffc0204c94:	bf863603          	ld	a2,-1032(a2) # ffffffffc02b2888 <pages>
ffffffffc0204c98:	8d91                	sub	a1,a1,a2
ffffffffc0204c9a:	4065d613          	srai	a2,a1,0x6
ffffffffc0204c9e:	00004717          	auipc	a4,0x4
ffffffffc0204ca2:	03a73703          	ld	a4,58(a4) # ffffffffc0208cd8 <nbase>
ffffffffc0204ca6:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc0204ca8:	00c61713          	slli	a4,a2,0xc
ffffffffc0204cac:	8331                	srli	a4,a4,0xc
ffffffffc0204cae:	000ae697          	auipc	a3,0xae
ffffffffc0204cb2:	bd26b683          	ld	a3,-1070(a3) # ffffffffc02b2880 <npage>
ffffffffc0204cb6:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204cba:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc0204cbc:	02d77963          	bgeu	a4,a3,ffffffffc0204cee <swapfs_write+0x74>
}
ffffffffc0204cc0:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204cc2:	000ae797          	auipc	a5,0xae
ffffffffc0204cc6:	bd67b783          	ld	a5,-1066(a5) # ffffffffc02b2898 <va_pa_offset>
ffffffffc0204cca:	46a1                	li	a3,8
ffffffffc0204ccc:	963e                	add	a2,a2,a5
ffffffffc0204cce:	4505                	li	a0,1
}
ffffffffc0204cd0:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204cd2:	94bfb06f          	j	ffffffffc020061c <ide_write_secs>
ffffffffc0204cd6:	86aa                	mv	a3,a0
ffffffffc0204cd8:	00003617          	auipc	a2,0x3
ffffffffc0204cdc:	6e060613          	addi	a2,a2,1760 # ffffffffc02083b8 <default_pmm_manager+0x1070>
ffffffffc0204ce0:	45e5                	li	a1,25
ffffffffc0204ce2:	00003517          	auipc	a0,0x3
ffffffffc0204ce6:	6be50513          	addi	a0,a0,1726 # ffffffffc02083a0 <default_pmm_manager+0x1058>
ffffffffc0204cea:	f90fb0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0204cee:	86b2                	mv	a3,a2
ffffffffc0204cf0:	06900593          	li	a1,105
ffffffffc0204cf4:	00002617          	auipc	a2,0x2
ffffffffc0204cf8:	68c60613          	addi	a2,a2,1676 # ffffffffc0207380 <default_pmm_manager+0x38>
ffffffffc0204cfc:	00002517          	auipc	a0,0x2
ffffffffc0204d00:	6ac50513          	addi	a0,a0,1708 # ffffffffc02073a8 <default_pmm_manager+0x60>
ffffffffc0204d04:	f76fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204d08 <kernel_thread_entry>:
.text
...
ffffffffc0204d08:	8526                	mv	a0,s1
	jalr s0
ffffffffc0204d0a:	9402                	jalr	s0

	jal do_exit
ffffffffc0204d0c:	616000ef          	jal	ra,ffffffffc0205322 <do_exit>

ffffffffc0204d10 <alloc_proc>:
...
alloc_proc(void) {
ffffffffc0204d10:	1141                	addi	sp,sp,-16
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204d12:	10800513          	li	a0,264
alloc_proc(void) {
ffffffffc0204d16:	e022                	sd	s0,0(sp)
ffffffffc0204d18:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204d1a:	de9fc0ef          	jal	ra,ffffffffc0201b02 <kmalloc>
ffffffffc0204d1e:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc0204d20:	cd21                	beqz	a0,ffffffffc0204d78 <alloc_proc+0x68>
...
ffffffffc0204d22:	57fd                	li	a5,-1
ffffffffc0204d24:	1782                	slli	a5,a5,0x20
ffffffffc0204d26:	e11c                	sd	a5,0(a0)
        proc -> runs = 0;
        proc -> kstack = 0;
        proc -> need_resched = 0;
        proc -> parent = NULL;
...
ffffffffc0204d28:	07000613          	li	a2,112
ffffffffc0204d2c:	4581                	li	a1,0
        proc -> runs = 0;
ffffffffc0204d2e:	00052423          	sw	zero,8(a0)
        proc -> kstack = 0;
ffffffffc0204d32:	00053823          	sd	zero,16(a0)
        proc -> need_resched = 0;
ffffffffc0204d36:	00053c23          	sd	zero,24(a0)
        proc -> parent = NULL;
ffffffffc0204d3a:	02053023          	sd	zero,32(a0)
        proc -> mm = NULL;
ffffffffc0204d3e:	02053423          	sd	zero,40(a0)
        memset(&(proc -> context), 0, sizeof(struct context));
ffffffffc0204d42:	03050513          	addi	a0,a0,48
ffffffffc0204d46:	083010ef          	jal	ra,ffffffffc02065c8 <memset>
        proc -> tf = NULL;
        proc -> cr3 = boot_cr3;
ffffffffc0204d4a:	000ae797          	auipc	a5,0xae
ffffffffc0204d4e:	b267b783          	ld	a5,-1242(a5) # ffffffffc02b2870 <boot_cr3>
        proc -> tf = NULL;
ffffffffc0204d52:	0a043023          	sd	zero,160(s0)
        proc -> cr3 = boot_cr3;
ffffffffc0204d56:	f45c                	sd	a5,168(s0)
        proc -> flags = 0;
ffffffffc0204d58:	0a042823          	sw	zero,176(s0)
        memset(proc->name, 0, PROC_NAME_LEN);
ffffffffc0204d5c:	463d                	li	a2,15
ffffffffc0204d5e:	4581                	li	a1,0
ffffffffc0204d60:	0b440513          	addi	a0,s0,180
ffffffffc0204d64:	065010ef          	jal	ra,ffffffffc02065c8 <memset>
     ...
     */
        ...
        proc -> wait_state = 0;
ffffffffc0204d68:	0e042623          	sw	zero,236(s0)
        proc -> cptr = NULL;
ffffffffc0204d6c:	0e043823          	sd	zero,240(s0)
        proc -> yptr = NULL;
ffffffffc0204d70:	0e043c23          	sd	zero,248(s0)
        proc -> optr = NULL;
ffffffffc0204d74:	10043023          	sd	zero,256(s0)
...
ffffffffc0204d86:	b467b783          	ld	a5,-1210(a5) # ffffffffc02b28c8 <current>
ffffffffc0204d8a:	73c8                	ld	a0,160(a5)
ffffffffc0204d8c:	febfb06f          	j	ffffffffc0200d76 <forkrets>

ffffffffc0204d90 <user_main>:
...
ffffffffc0204d90:	000ae797          	auipc	a5,0xae
ffffffffc0204d94:	b387b783          	ld	a5,-1224(a5) # ffffffffc02b28c8 <current>
ffffffffc0204d98:	43cc                	lw	a1,4(a5)
user_main(void *arg) {
ffffffffc0204d9a:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204d9c:	00003617          	auipc	a2,0x3
ffffffffc0204da0:	63c60613          	addi	a2,a2,1596 # ffffffffc02083d8 <default_pmm_manager+0x1090>
ffffffffc0204da4:	00003517          	auipc	a0,0x3
ffffffffc0204da8:	64450513          	addi	a0,a0,1604 # ffffffffc02083e8 <default_pmm_manager+0x10a0>
user_main(void *arg) {
ffffffffc0204dac:	fc06                	sd	ra,56(sp)
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204dae:	bd2fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc0204db2:	3fe06797          	auipc	a5,0x3fe06
ffffffffc0204db6:	bbe78793          	addi	a5,a5,-1090 # a970 <_binary_obj___user_forktest_out_size>
ffffffffc0204dba:	e43e                	sd	a5,8(sp)
ffffffffc0204dbc:	00003517          	auipc	a0,0x3
ffffffffc0204dc0:	61c50513          	addi	a0,a0,1564 # ffffffffc02083d8 <default_pmm_manager+0x1090>
ffffffffc0204dc4:	00046797          	auipc	a5,0x46
ffffffffc0204dc8:	97c78793          	addi	a5,a5,-1668 # ffffffffc024a740 <_binary_obj___user_forktest_out_start>
ffffffffc0204dcc:	f03e                	sd	a5,32(sp)
ffffffffc0204dce:	f42a                	sd	a0,40(sp)
    int64_t ret=0, len = strlen(name);
ffffffffc0204dd0:	e802                	sd	zero,16(sp)
ffffffffc0204dd2:	77a010ef          	jal	ra,ffffffffc020654c <strlen>
ffffffffc0204dd6:	ec2a                	sd	a0,24(sp)
    asm volatile(
ffffffffc0204dd8:	4511                	li	a0,4
ffffffffc0204dda:	55a2                	lw	a1,40(sp)
ffffffffc0204ddc:	4662                	lw	a2,24(sp)
ffffffffc0204dde:	5682                	lw	a3,32(sp)
ffffffffc0204de0:	4722                	lw	a4,8(sp)
ffffffffc0204de2:	48a9                	li	a7,10
ffffffffc0204de4:	9002                	ebreak
ffffffffc0204de6:	c82a                	sw	a0,16(sp)
    cprintf("ret = %d\n", ret);
ffffffffc0204de8:	65c2                	ld	a1,16(sp)
ffffffffc0204dea:	00003517          	auipc	a0,0x3
ffffffffc0204dee:	62650513          	addi	a0,a0,1574 # ffffffffc0208410 <default_pmm_manager+0x10c8>
ffffffffc0204df2:	b8efb0ef          	jal	ra,ffffffffc0200180 <cprintf>
#else
    KERNEL_EXECVE(exit);
#endif
    panic("user_main execve failed.\n");
ffffffffc0204df6:	00003617          	auipc	a2,0x3
ffffffffc0204dfa:	62a60613          	addi	a2,a2,1578 # ffffffffc0208420 <default_pmm_manager+0x10d8>
ffffffffc0204dfe:	35900593          	li	a1,857
ffffffffc0204e02:	00003517          	auipc	a0,0x3
ffffffffc0204e06:	63e50513          	addi	a0,a0,1598 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0204e0a:	e70fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204e0e <put_pgdir>:
    return pa2page(PADDR(kva));
ffffffffc0204e0e:	6d14                	ld	a3,24(a0)
put_pgdir(struct mm_struct *mm) {
ffffffffc0204e10:	1141                	addi	sp,sp,-16
ffffffffc0204e12:	e406                	sd	ra,8(sp)
ffffffffc0204e14:	c02007b7          	lui	a5,0xc0200
ffffffffc0204e18:	02f6ee63          	bltu	a3,a5,ffffffffc0204e54 <put_pgdir+0x46>
ffffffffc0204e1c:	000ae517          	auipc	a0,0xae
ffffffffc0204e20:	a7c53503          	ld	a0,-1412(a0) # ffffffffc02b2898 <va_pa_offset>
ffffffffc0204e24:	8e89                	sub	a3,a3,a0
    if (PPN(pa) >= npage) {
ffffffffc0204e26:	82b1                	srli	a3,a3,0xc
ffffffffc0204e28:	000ae797          	auipc	a5,0xae
ffffffffc0204e2c:	a587b783          	ld	a5,-1448(a5) # ffffffffc02b2880 <npage>
ffffffffc0204e30:	02f6fe63          	bgeu	a3,a5,ffffffffc0204e6c <put_pgdir+0x5e>
    return &pages[PPN(pa) - nbase];
ffffffffc0204e34:	00004517          	auipc	a0,0x4
ffffffffc0204e38:	ea453503          	ld	a0,-348(a0) # ffffffffc0208cd8 <nbase>
}
ffffffffc0204e3c:	60a2                	ld	ra,8(sp)
ffffffffc0204e3e:	8e89                	sub	a3,a3,a0
ffffffffc0204e40:	069a                	slli	a3,a3,0x6
    free_page(kva2page(mm->pgdir));
ffffffffc0204e42:	000ae517          	auipc	a0,0xae
ffffffffc0204e46:	a4653503          	ld	a0,-1466(a0) # ffffffffc02b2888 <pages>
ffffffffc0204e4a:	4585                	li	a1,1
ffffffffc0204e4c:	9536                	add	a0,a0,a3
}
ffffffffc0204e4e:	0141                	addi	sp,sp,16
    free_page(kva2page(mm->pgdir));
ffffffffc0204e50:	f23fc06f          	j	ffffffffc0201d72 <free_pages>
    return pa2page(PADDR(kva));
ffffffffc0204e54:	00002617          	auipc	a2,0x2
ffffffffc0204e58:	5d460613          	addi	a2,a2,1492 # ffffffffc0207428 <default_pmm_manager+0xe0>
ffffffffc0204e5c:	06e00593          	li	a1,110
ffffffffc0204e60:	00002517          	auipc	a0,0x2
ffffffffc0204e64:	54850513          	addi	a0,a0,1352 # ffffffffc02073a8 <default_pmm_manager+0x60>
ffffffffc0204e68:	e12fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204e6c:	00002617          	auipc	a2,0x2
ffffffffc0204e70:	5e460613          	addi	a2,a2,1508 # ffffffffc0207450 <default_pmm_manager+0x108>
ffffffffc0204e74:	06200593          	li	a1,98
ffffffffc0204e78:	00002517          	auipc	a0,0x2
ffffffffc0204e7c:	53050513          	addi	a0,a0,1328 # ffffffffc02073a8 <default_pmm_manager+0x60>
ffffffffc0204e80:	dfafb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204e84 <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc0204e84:	7179                	addi	sp,sp,-48
ffffffffc0204e86:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204e88:	000ae917          	auipc	s2,0xae
ffffffffc0204e8c:	a4090913          	addi	s2,s2,-1472 # ffffffffc02b28c8 <current>
proc_run(struct proc_struct *proc) {
ffffffffc0204e90:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204e92:	00093483          	ld	s1,0(s2)
proc_run(struct proc_struct *proc) {
ffffffffc0204e96:	f406                	sd	ra,40(sp)
ffffffffc0204e98:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc0204e9a:	02a48863          	beq	s1,a0,ffffffffc0204eca <proc_run+0x46>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204e9e:	100027f3          	csrr	a5,sstatus
ffffffffc0204ea2:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204ea4:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204ea6:	ef9d                	bnez	a5,ffffffffc0204ee4 <proc_run+0x60>
...
ffffffffc0204ea8:	755c                	ld	a5,168(a0)
ffffffffc0204eaa:	577d                	li	a4,-1
ffffffffc0204eac:	177e                	slli	a4,a4,0x3f
ffffffffc0204eae:	83b1                	srli	a5,a5,0xc
            current = proc;
ffffffffc0204eb0:	00a93023          	sd	a0,0(s2)
ffffffffc0204eb4:	8fd9                	or	a5,a5,a4
ffffffffc0204eb6:	18079073          	csrw	satp,a5
            switch_to(&(temp -> context), &(proc -> context));
ffffffffc0204eba:	03050593          	addi	a1,a0,48
ffffffffc0204ebe:	03048513          	addi	a0,s1,48
ffffffffc0204ec2:	030010ef          	jal	ra,ffffffffc0205ef2 <switch_to>
    if (flag) {
ffffffffc0204ec6:	00099863          	bnez	s3,ffffffffc0204ed6 <proc_run+0x52>
}
ffffffffc0204eca:	70a2                	ld	ra,40(sp)
ffffffffc0204ecc:	7482                	ld	s1,32(sp)
ffffffffc0204ece:	6962                	ld	s2,24(sp)
ffffffffc0204ed0:	69c2                	ld	s3,16(sp)
ffffffffc0204ed2:	6145                	addi	sp,sp,48
ffffffffc0204ed4:	8082                	ret
ffffffffc0204ed6:	70a2                	ld	ra,40(sp)
ffffffffc0204ed8:	7482                	ld	s1,32(sp)
ffffffffc0204eda:	6962                	ld	s2,24(sp)
ffffffffc0204edc:	69c2                	ld	s3,16(sp)
ffffffffc0204ede:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204ee0:	f60fb06f          	j	ffffffffc0200640 <intr_enable>
ffffffffc0204ee4:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0204ee6:	f60fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0204eea:	6522                	ld	a0,8(sp)
ffffffffc0204eec:	4985                	li	s3,1
ffffffffc0204eee:	bf6d                	j	ffffffffc0204ea8 <proc_run+0x24>

ffffffffc0204ef0 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204ef0:	7119                	addi	sp,sp,-128
ffffffffc0204ef2:	f0ca                	sd	s2,96(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204ef4:	000ae917          	auipc	s2,0xae
ffffffffc0204ef8:	9ec90913          	addi	s2,s2,-1556 # ffffffffc02b28e0 <nr_process>
ffffffffc0204efc:	00092703          	lw	a4,0(s2)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204f00:	fc86                	sd	ra,120(sp)
ffffffffc0204f02:	f8a2                	sd	s0,112(sp)
ffffffffc0204f04:	f4a6                	sd	s1,104(sp)
ffffffffc0204f06:	ecce                	sd	s3,88(sp)
ffffffffc0204f08:	e8d2                	sd	s4,80(sp)
ffffffffc0204f0a:	e4d6                	sd	s5,72(sp)
ffffffffc0204f0c:	e0da                	sd	s6,64(sp)
ffffffffc0204f0e:	fc5e                	sd	s7,56(sp)
ffffffffc0204f10:	f862                	sd	s8,48(sp)
ffffffffc0204f12:	f466                	sd	s9,40(sp)
ffffffffc0204f14:	f06a                	sd	s10,32(sp)
ffffffffc0204f16:	ec6e                	sd	s11,24(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204f18:	6785                	lui	a5,0x1
ffffffffc0204f1a:	32f75a63          	bge	a4,a5,ffffffffc020524e <do_fork+0x35e>
ffffffffc0204f1e:	8a2a                	mv	s4,a0
ffffffffc0204f20:	89ae                	mv	s3,a1
ffffffffc0204f22:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL) {
ffffffffc0204f24:	dedff0ef          	jal	ra,ffffffffc0204d10 <alloc_proc>
ffffffffc0204f28:	84aa                	mv	s1,a0
ffffffffc0204f2a:	30050363          	beqz	a0,ffffffffc0205230 <do_fork+0x340>
    proc -> parent = current;
ffffffffc0204f2e:	000aec17          	auipc	s8,0xae
ffffffffc0204f32:	99ac0c13          	addi	s8,s8,-1638 # ffffffffc02b28c8 <current>
ffffffffc0204f36:	000c3783          	ld	a5,0(s8)
    if (current -> wait_state != 0){
ffffffffc0204f3a:	0ec7a703          	lw	a4,236(a5) # 10ec <_binary_obj___user_faultread_out_size-0x8acc>
    proc -> parent = current;
ffffffffc0204f3e:	f11c                	sd	a5,32(a0)
    if (current -> wait_state != 0){
ffffffffc0204f40:	2e071863          	bnez	a4,ffffffffc0205230 <do_fork+0x340>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204f44:	4509                	li	a0,2
ffffffffc0204f46:	d9bfc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
    if (page != NULL) {
ffffffffc0204f4a:	2e050063          	beqz	a0,ffffffffc020522a <do_fork+0x33a>
    return page - pages + nbase;
ffffffffc0204f4e:	000aea97          	auipc	s5,0xae
ffffffffc0204f52:	93aa8a93          	addi	s5,s5,-1734 # ffffffffc02b2888 <pages>
ffffffffc0204f56:	000ab683          	ld	a3,0(s5)
ffffffffc0204f5a:	00004b17          	auipc	s6,0x4
ffffffffc0204f5e:	d7eb0b13          	addi	s6,s6,-642 # ffffffffc0208cd8 <nbase>
ffffffffc0204f62:	000b3783          	ld	a5,0(s6)
ffffffffc0204f66:	40d506b3          	sub	a3,a0,a3
    return KADDR(page2pa(page));
ffffffffc0204f6a:	000aeb97          	auipc	s7,0xae
ffffffffc0204f6e:	916b8b93          	addi	s7,s7,-1770 # ffffffffc02b2880 <npage>
    return page - pages + nbase;
ffffffffc0204f72:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0204f74:	5dfd                	li	s11,-1
ffffffffc0204f76:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc0204f7a:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204f7c:	00cddd93          	srli	s11,s11,0xc
ffffffffc0204f80:	01b6f633          	and	a2,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0204f84:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204f86:	30e67d63          	bgeu	a2,a4,ffffffffc02052a0 <do_fork+0x3b0>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0204f8a:	000c3603          	ld	a2,0(s8)
ffffffffc0204f8e:	000aec17          	auipc	s8,0xae
ffffffffc0204f92:	90ac0c13          	addi	s8,s8,-1782 # ffffffffc02b2898 <va_pa_offset>
ffffffffc0204f96:	000c3703          	ld	a4,0(s8)
ffffffffc0204f9a:	02863d03          	ld	s10,40(a2)
ffffffffc0204f9e:	e43e                	sd	a5,8(sp)
ffffffffc0204fa0:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204fa2:	e894                	sd	a3,16(s1)
    if (oldmm == NULL) {
ffffffffc0204fa4:	020d0863          	beqz	s10,ffffffffc0204fd4 <do_fork+0xe4>
    if (clone_flags & CLONE_VM) {
ffffffffc0204fa8:	100a7a13          	andi	s4,s4,256
ffffffffc0204fac:	1c0a0163          	beqz	s4,ffffffffc020516e <do_fork+0x27e>
}

static inline int
mm_count_inc(struct mm_struct *mm) {
    mm->mm_count += 1;
ffffffffc0204fb0:	030d2703          	lw	a4,48(s10)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204fb4:	018d3783          	ld	a5,24(s10)
ffffffffc0204fb8:	c02006b7          	lui	a3,0xc0200
ffffffffc0204fbc:	2705                	addiw	a4,a4,1
ffffffffc0204fbe:	02ed2823          	sw	a4,48(s10)
    proc->mm = mm;
ffffffffc0204fc2:	03a4b423          	sd	s10,40(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204fc6:	2ed7e963          	bltu	a5,a3,ffffffffc02052b8 <do_fork+0x3c8>
ffffffffc0204fca:	000c3703          	ld	a4,0(s8)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204fce:	6894                	ld	a3,16(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204fd0:	8f99                	sub	a5,a5,a4
ffffffffc0204fd2:	f4dc                	sd	a5,168(s1)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204fd4:	6789                	lui	a5,0x2
ffffffffc0204fd6:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7cd8>
ffffffffc0204fda:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204fdc:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204fde:	f0d4                	sd	a3,160(s1)
    *(proc->tf) = *tf;
ffffffffc0204fe0:	87b6                	mv	a5,a3
ffffffffc0204fe2:	12040893          	addi	a7,s0,288
ffffffffc0204fe6:	00063803          	ld	a6,0(a2)
ffffffffc0204fea:	6608                	ld	a0,8(a2)
ffffffffc0204fec:	6a0c                	ld	a1,16(a2)
ffffffffc0204fee:	6e18                	ld	a4,24(a2)
ffffffffc0204ff0:	0107b023          	sd	a6,0(a5)
ffffffffc0204ff4:	e788                	sd	a0,8(a5)
ffffffffc0204ff6:	eb8c                	sd	a1,16(a5)
ffffffffc0204ff8:	ef98                	sd	a4,24(a5)
ffffffffc0204ffa:	02060613          	addi	a2,a2,32
ffffffffc0204ffe:	02078793          	addi	a5,a5,32
ffffffffc0205002:	ff1612e3          	bne	a2,a7,ffffffffc0204fe6 <do_fork+0xf6>
    proc->tf->gpr.a0 = 0;
ffffffffc0205006:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x1e>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020500a:	12098f63          	beqz	s3,ffffffffc0205148 <do_fork+0x258>
ffffffffc020500e:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0205012:	00000797          	auipc	a5,0x0
ffffffffc0205016:	d7078793          	addi	a5,a5,-656 # ffffffffc0204d82 <forkret>
ffffffffc020501a:	f89c                	sd	a5,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020501c:	fc94                	sd	a3,56(s1)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020501e:	100027f3          	csrr	a5,sstatus
ffffffffc0205022:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205024:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205026:	14079063          	bnez	a5,ffffffffc0205166 <do_fork+0x276>
    if (++ last_pid >= MAX_PID) {
ffffffffc020502a:	000a2817          	auipc	a6,0xa2
ffffffffc020502e:	35680813          	addi	a6,a6,854 # ffffffffc02a7380 <last_pid.1>
ffffffffc0205032:	00082783          	lw	a5,0(a6)
ffffffffc0205036:	6709                	lui	a4,0x2
ffffffffc0205038:	0017851b          	addiw	a0,a5,1
ffffffffc020503c:	00a82023          	sw	a0,0(a6)
ffffffffc0205040:	08e55d63          	bge	a0,a4,ffffffffc02050da <do_fork+0x1ea>
    if (last_pid >= next_safe) {
ffffffffc0205044:	000a2317          	auipc	t1,0xa2
ffffffffc0205048:	34030313          	addi	t1,t1,832 # ffffffffc02a7384 <next_safe.0>
ffffffffc020504c:	00032783          	lw	a5,0(t1)
ffffffffc0205050:	000ad417          	auipc	s0,0xad
ffffffffc0205054:	7f040413          	addi	s0,s0,2032 # ffffffffc02b2840 <proc_list>
ffffffffc0205058:	08f55963          	bge	a0,a5,ffffffffc02050ea <do_fork+0x1fa>
    proc -> pid = get_pid();
ffffffffc020505c:	c0c8                	sw	a0,4(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020505e:	45a9                	li	a1,10
ffffffffc0205060:	2501                	sext.w	a0,a0
ffffffffc0205062:	0e6010ef          	jal	ra,ffffffffc0206148 <hash32>
ffffffffc0205066:	02051793          	slli	a5,a0,0x20
ffffffffc020506a:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020506e:	000a9797          	auipc	a5,0xa9
ffffffffc0205072:	7d278793          	addi	a5,a5,2002 # ffffffffc02ae840 <hash_list>
ffffffffc0205076:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0205078:	650c                	ld	a1,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc020507a:	7094                	ld	a3,32(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020507c:	0d848793          	addi	a5,s1,216
    prev->next = next->prev = elm;
ffffffffc0205080:	e19c                	sd	a5,0(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc0205082:	6410                	ld	a2,8(s0)
    prev->next = next->prev = elm;
ffffffffc0205084:	e51c                	sd	a5,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc0205086:	7af8                	ld	a4,240(a3)
    list_add(&proc_list, &(proc->list_link));
ffffffffc0205088:	0c848793          	addi	a5,s1,200
    elm->next = next;
ffffffffc020508c:	f0ec                	sd	a1,224(s1)
    elm->prev = prev;
ffffffffc020508e:	ece8                	sd	a0,216(s1)
    prev->next = next->prev = elm;
ffffffffc0205090:	e21c                	sd	a5,0(a2)
ffffffffc0205092:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc0205094:	e8f0                	sd	a2,208(s1)
    elm->prev = prev;
ffffffffc0205096:	e4e0                	sd	s0,200(s1)
    proc->yptr = NULL;
ffffffffc0205098:	0e04bc23          	sd	zero,248(s1)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc020509c:	10e4b023          	sd	a4,256(s1)
ffffffffc02050a0:	c311                	beqz	a4,ffffffffc02050a4 <do_fork+0x1b4>
        proc->optr->yptr = proc;
ffffffffc02050a2:	ff64                	sd	s1,248(a4)
    nr_process ++;
ffffffffc02050a4:	00092783          	lw	a5,0(s2)
    proc->parent->cptr = proc;
ffffffffc02050a8:	fae4                	sd	s1,240(a3)
    nr_process ++;
ffffffffc02050aa:	2785                	addiw	a5,a5,1
ffffffffc02050ac:	00f92023          	sw	a5,0(s2)
    if (flag) {
ffffffffc02050b0:	18099263          	bnez	s3,ffffffffc0205234 <do_fork+0x344>
    wakeup_proc(proc);
ffffffffc02050b4:	8526                	mv	a0,s1
ffffffffc02050b6:	6a7000ef          	jal	ra,ffffffffc0205f5c <wakeup_proc>
    ret = proc -> pid;
ffffffffc02050ba:	40c8                	lw	a0,4(s1)
}
ffffffffc02050bc:	70e6                	ld	ra,120(sp)
ffffffffc02050be:	7446                	ld	s0,112(sp)
ffffffffc02050c0:	74a6                	ld	s1,104(sp)
ffffffffc02050c2:	7906                	ld	s2,96(sp)
ffffffffc02050c4:	69e6                	ld	s3,88(sp)
ffffffffc02050c6:	6a46                	ld	s4,80(sp)
ffffffffc02050c8:	6aa6                	ld	s5,72(sp)
ffffffffc02050ca:	6b06                	ld	s6,64(sp)
ffffffffc02050cc:	7be2                	ld	s7,56(sp)
ffffffffc02050ce:	7c42                	ld	s8,48(sp)
ffffffffc02050d0:	7ca2                	ld	s9,40(sp)
ffffffffc02050d2:	7d02                	ld	s10,32(sp)
ffffffffc02050d4:	6de2                	ld	s11,24(sp)
ffffffffc02050d6:	6109                	addi	sp,sp,128
ffffffffc02050d8:	8082                	ret
        last_pid = 1;
ffffffffc02050da:	4785                	li	a5,1
ffffffffc02050dc:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02050e0:	4505                	li	a0,1
ffffffffc02050e2:	000a2317          	auipc	t1,0xa2
ffffffffc02050e6:	2a230313          	addi	t1,t1,674 # ffffffffc02a7384 <next_safe.0>
    return listelm->next;
ffffffffc02050ea:	000ad417          	auipc	s0,0xad
ffffffffc02050ee:	75640413          	addi	s0,s0,1878 # ffffffffc02b2840 <proc_list>
ffffffffc02050f2:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02050f6:	6789                	lui	a5,0x2
ffffffffc02050f8:	00f32023          	sw	a5,0(t1)
ffffffffc02050fc:	86aa                	mv	a3,a0
ffffffffc02050fe:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc0205100:	6e89                	lui	t4,0x2
ffffffffc0205102:	148e0163          	beq	t3,s0,ffffffffc0205244 <do_fork+0x354>
ffffffffc0205106:	88ae                	mv	a7,a1
ffffffffc0205108:	87f2                	mv	a5,t3
ffffffffc020510a:	6609                	lui	a2,0x2
ffffffffc020510c:	a811                	j	ffffffffc0205120 <do_fork+0x230>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc020510e:	00e6d663          	bge	a3,a4,ffffffffc020511a <do_fork+0x22a>
ffffffffc0205112:	00c75463          	bge	a4,a2,ffffffffc020511a <do_fork+0x22a>
ffffffffc0205116:	863a                	mv	a2,a4
ffffffffc0205118:	4885                	li	a7,1
ffffffffc020511a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020511c:	00878d63          	beq	a5,s0,ffffffffc0205136 <do_fork+0x246>
            if (proc->pid == last_pid) {
ffffffffc0205120:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7c7c>
ffffffffc0205124:	fed715e3          	bne	a4,a3,ffffffffc020510e <do_fork+0x21e>
                if (++ last_pid >= next_safe) {
ffffffffc0205128:	2685                	addiw	a3,a3,1
ffffffffc020512a:	10c6d863          	bge	a3,a2,ffffffffc020523a <do_fork+0x34a>
ffffffffc020512e:	679c                	ld	a5,8(a5)
ffffffffc0205130:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0205132:	fe8797e3          	bne	a5,s0,ffffffffc0205120 <do_fork+0x230>
ffffffffc0205136:	c581                	beqz	a1,ffffffffc020513e <do_fork+0x24e>
ffffffffc0205138:	00d82023          	sw	a3,0(a6)
ffffffffc020513c:	8536                	mv	a0,a3
ffffffffc020513e:	f0088fe3          	beqz	a7,ffffffffc020505c <do_fork+0x16c>
ffffffffc0205142:	00c32023          	sw	a2,0(t1)
ffffffffc0205146:	bf19                	j	ffffffffc020505c <do_fork+0x16c>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0205148:	89b6                	mv	s3,a3
ffffffffc020514a:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020514e:	00000797          	auipc	a5,0x0
ffffffffc0205152:	c3478793          	addi	a5,a5,-972 # ffffffffc0204d82 <forkret>
ffffffffc0205156:	f89c                	sd	a5,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0205158:	fc94                	sd	a3,56(s1)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0205160:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205162:	ec0784e3          	beqz	a5,ffffffffc020502a <do_fork+0x13a>
        intr_disable();
ffffffffc0205166:	ce0fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc020516a:	4985                	li	s3,1
ffffffffc020516c:	bd7d                	j	ffffffffc020502a <do_fork+0x13a>
    if ((mm = mm_create()) == NULL) {
ffffffffc020516e:	fb3fe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc0205172:	8caa                	mv	s9,a0
ffffffffc0205174:	c159                	beqz	a0,ffffffffc02051fa <do_fork+0x30a>
    if ((page = alloc_page()) == NULL) {
ffffffffc0205176:	4505                	li	a0,1
ffffffffc0205178:	b69fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc020517c:	cd25                	beqz	a0,ffffffffc02051f4 <do_fork+0x304>
    return page - pages + nbase;
ffffffffc020517e:	000ab683          	ld	a3,0(s5)
ffffffffc0205182:	67a2                	ld	a5,8(sp)
    return KADDR(page2pa(page));
ffffffffc0205184:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc0205188:	40d506b3          	sub	a3,a0,a3
ffffffffc020518c:	8699                	srai	a3,a3,0x6
ffffffffc020518e:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205190:	01b6fdb3          	and	s11,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0205194:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205196:	10edf563          	bgeu	s11,a4,ffffffffc02052a0 <do_fork+0x3b0>
ffffffffc020519a:	000c3a03          	ld	s4,0(s8)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc020519e:	6605                	lui	a2,0x1
ffffffffc02051a0:	000ad597          	auipc	a1,0xad
ffffffffc02051a4:	6d85b583          	ld	a1,1752(a1) # ffffffffc02b2878 <boot_pgdir>
ffffffffc02051a8:	9a36                	add	s4,s4,a3
ffffffffc02051aa:	8552                	mv	a0,s4
ffffffffc02051ac:	42e010ef          	jal	ra,ffffffffc02065da <memcpy>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc02051b0:	038d0d93          	addi	s11,s10,56
    mm->pgdir = pgdir;
ffffffffc02051b4:	014cbc23          	sd	s4,24(s9)
...
ffffffffc02051ba:	40fdb7af          	amoor.d	a5,a5,(s11)
...
ffffffffc02051c0:	4a05                	li	s4,1
ffffffffc02051c2:	c799                	beqz	a5,ffffffffc02051d0 <do_fork+0x2e0>
        schedule();
ffffffffc02051c4:	619000ef          	jal	ra,ffffffffc0205fdc <schedule>
ffffffffc02051c8:	414db7af          	amoor.d	a5,s4,(s11)
    while (!try_lock(lock)) {
ffffffffc02051cc:	8b85                	andi	a5,a5,1
ffffffffc02051ce:	fbfd                	bnez	a5,ffffffffc02051c4 <do_fork+0x2d4>
        ret = dup_mmap(mm, oldmm);
ffffffffc02051d0:	85ea                	mv	a1,s10
ffffffffc02051d2:	8566                	mv	a0,s9
ffffffffc02051d4:	9d4ff0ef          	jal	ra,ffffffffc02043a8 <dup_mmap>
...
ffffffffc02051d8:	57f9                	li	a5,-2
ffffffffc02051da:	60fdb7af          	amoand.d	a5,a5,(s11)
ffffffffc02051de:	8b85                	andi	a5,a5,1
    }
}
...
ffffffffc02051e0:	c7c5                	beqz	a5,ffffffffc0205288 <do_fork+0x398>
good_mm:
ffffffffc02051e2:	8d66                	mv	s10,s9
    if (ret != 0) {
ffffffffc02051e4:	dc0506e3          	beqz	a0,ffffffffc0204fb0 <do_fork+0xc0>
    exit_mmap(mm);
ffffffffc02051e8:	8566                	mv	a0,s9
ffffffffc02051ea:	a58ff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc02051ee:	8566                	mv	a0,s9
ffffffffc02051f0:	c1fff0ef          	jal	ra,ffffffffc0204e0e <put_pgdir>
    mm_destroy(mm);
ffffffffc02051f4:	8566                	mv	a0,s9
ffffffffc02051f6:	8b0ff0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02051fa:	6894                	ld	a3,16(s1)
    return pa2page(PADDR(kva));
ffffffffc02051fc:	c02007b7          	lui	a5,0xc0200
ffffffffc0205200:	06f6e863          	bltu	a3,a5,ffffffffc0205270 <do_fork+0x380>
ffffffffc0205204:	000c3783          	ld	a5,0(s8)
    if (PPN(pa) >= npage) {
ffffffffc0205208:	000bb703          	ld	a4,0(s7)
    return pa2page(PADDR(kva));
ffffffffc020520c:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc0205210:	83b1                	srli	a5,a5,0xc
ffffffffc0205212:	04e7f363          	bgeu	a5,a4,ffffffffc0205258 <do_fork+0x368>
    return &pages[PPN(pa) - nbase];
ffffffffc0205216:	000b3703          	ld	a4,0(s6)
ffffffffc020521a:	000ab503          	ld	a0,0(s5)
ffffffffc020521e:	4589                	li	a1,2
ffffffffc0205220:	8f99                	sub	a5,a5,a4
ffffffffc0205222:	079a                	slli	a5,a5,0x6
ffffffffc0205224:	953e                	add	a0,a0,a5
ffffffffc0205226:	b4dfc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
...
ffffffffc0205230:	5571                	li	a0,-4
    return ret;
ffffffffc0205232:	b569                	j	ffffffffc02050bc <do_fork+0x1cc>
        intr_enable();
ffffffffc0205234:	c0cfb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc0205238:	bdb5                	j	ffffffffc02050b4 <do_fork+0x1c4>
                    if (last_pid >= MAX_PID) {
ffffffffc020523a:	01d6c363          	blt	a3,t4,ffffffffc0205240 <do_fork+0x350>
                        last_pid = 1;
ffffffffc020523e:	4685                	li	a3,1
                    goto repeat;
ffffffffc0205240:	4585                	li	a1,1
ffffffffc0205242:	b5c1                	j	ffffffffc0205102 <do_fork+0x212>
ffffffffc0205244:	c599                	beqz	a1,ffffffffc0205252 <do_fork+0x362>
ffffffffc0205246:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020524a:	8536                	mv	a0,a3
ffffffffc020524c:	bd01                	j	ffffffffc020505c <do_fork+0x16c>
    int ret = -E_NO_FREE_PROC;
ffffffffc020524e:	556d                	li	a0,-5
ffffffffc0205250:	b5b5                	j	ffffffffc02050bc <do_fork+0x1cc>
    return last_pid;
ffffffffc0205252:	00082503          	lw	a0,0(a6)
ffffffffc0205256:	b519                	j	ffffffffc020505c <do_fork+0x16c>
        panic("pa2page called with invalid pa");
ffffffffc0205258:	00002617          	auipc	a2,0x2
ffffffffc020525c:	1f860613          	addi	a2,a2,504 # ffffffffc0207450 <default_pmm_manager+0x108>
ffffffffc0205260:	06200593          	li	a1,98
ffffffffc0205264:	00002517          	auipc	a0,0x2
ffffffffc0205268:	14450513          	addi	a0,a0,324 # ffffffffc02073a8 <default_pmm_manager+0x60>
ffffffffc020526c:	a0efb0ef          	jal	ra,ffffffffc020047a <__panic>
    return pa2page(PADDR(kva));
ffffffffc0205270:	00002617          	auipc	a2,0x2
ffffffffc0205274:	1b860613          	addi	a2,a2,440 # ffffffffc0207428 <default_pmm_manager+0xe0>
ffffffffc0205278:	06e00593          	li	a1,110
ffffffffc020527c:	00002517          	auipc	a0,0x2
ffffffffc0205280:	12c50513          	addi	a0,a0,300 # ffffffffc02073a8 <default_pmm_manager+0x60>
ffffffffc0205284:	9f6fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("Unlock failed.\n");
ffffffffc0205288:	00003617          	auipc	a2,0x3
ffffffffc020528c:	1d060613          	addi	a2,a2,464 # ffffffffc0208458 <default_pmm_manager+0x1110>
ffffffffc0205290:	03100593          	li	a1,49
ffffffffc0205294:	00003517          	auipc	a0,0x3
ffffffffc0205298:	1d450513          	addi	a0,a0,468 # ffffffffc0208468 <default_pmm_manager+0x1120>
ffffffffc020529c:	9defb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc02052a0:	00002617          	auipc	a2,0x2
ffffffffc02052a4:	0e060613          	addi	a2,a2,224 # ffffffffc0207380 <default_pmm_manager+0x38>
ffffffffc02052a8:	06900593          	li	a1,105
ffffffffc02052ac:	00002517          	auipc	a0,0x2
ffffffffc02052b0:	0fc50513          	addi	a0,a0,252 # ffffffffc02073a8 <default_pmm_manager+0x60>
ffffffffc02052b4:	9c6fb0ef          	jal	ra,ffffffffc020047a <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc02052b8:	86be                	mv	a3,a5
ffffffffc02052ba:	00002617          	auipc	a2,0x2
ffffffffc02052be:	16e60613          	addi	a2,a2,366 # ffffffffc0207428 <default_pmm_manager+0xe0>
ffffffffc02052c2:	16600593          	li	a1,358
ffffffffc02052c6:	00003517          	auipc	a0,0x3
ffffffffc02052ca:	17a50513          	addi	a0,a0,378 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc02052ce:	9acfb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02052d2 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02052d2:	7129                	addi	sp,sp,-320
ffffffffc02052d4:	fa22                	sd	s0,304(sp)
ffffffffc02052d6:	f626                	sd	s1,296(sp)
ffffffffc02052d8:	f24a                	sd	s2,288(sp)
ffffffffc02052da:	84ae                	mv	s1,a1
ffffffffc02052dc:	892a                	mv	s2,a0
ffffffffc02052de:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02052e0:	4581                	li	a1,0
ffffffffc02052e2:	12000613          	li	a2,288
ffffffffc02052e6:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02052e8:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02052ea:	2de010ef          	jal	ra,ffffffffc02065c8 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02052ee:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02052f0:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02052f2:	100027f3          	csrr	a5,sstatus
ffffffffc02052f6:	edd7f793          	andi	a5,a5,-291
ffffffffc02052fa:	1207e793          	ori	a5,a5,288
ffffffffc02052fe:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0205300:	860a                	mv	a2,sp
ffffffffc0205302:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0205306:	00000797          	auipc	a5,0x0
ffffffffc020530a:	a0278793          	addi	a5,a5,-1534 # ffffffffc0204d08 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020530e:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0205310:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0205312:	bdfff0ef          	jal	ra,ffffffffc0204ef0 <do_fork>
}
ffffffffc0205316:	70f2                	ld	ra,312(sp)
ffffffffc0205318:	7452                	ld	s0,304(sp)
ffffffffc020531a:	74b2                	ld	s1,296(sp)
ffffffffc020531c:	7912                	ld	s2,288(sp)
ffffffffc020531e:	6131                	addi	sp,sp,320
ffffffffc0205320:	8082                	ret

ffffffffc0205322 <do_exit>:
do_exit(int error_code) {
ffffffffc0205322:	7179                	addi	sp,sp,-48
ffffffffc0205324:	f022                	sd	s0,32(sp)
    if (current == idleproc) {
ffffffffc0205326:	000ad417          	auipc	s0,0xad
ffffffffc020532a:	5a240413          	addi	s0,s0,1442 # ffffffffc02b28c8 <current>
ffffffffc020532e:	601c                	ld	a5,0(s0)
do_exit(int error_code) {
ffffffffc0205330:	f406                	sd	ra,40(sp)
ffffffffc0205332:	ec26                	sd	s1,24(sp)
ffffffffc0205334:	e84a                	sd	s2,16(sp)
ffffffffc0205336:	e44e                	sd	s3,8(sp)
ffffffffc0205338:	e052                	sd	s4,0(sp)
    if (current == idleproc) {
ffffffffc020533a:	000ad717          	auipc	a4,0xad
ffffffffc020533e:	59673703          	ld	a4,1430(a4) # ffffffffc02b28d0 <idleproc>
ffffffffc0205342:	0ce78c63          	beq	a5,a4,ffffffffc020541a <do_exit+0xf8>
    if (current == initproc) {
ffffffffc0205346:	000ad497          	auipc	s1,0xad
ffffffffc020534a:	59248493          	addi	s1,s1,1426 # ffffffffc02b28d8 <initproc>
ffffffffc020534e:	6098                	ld	a4,0(s1)
ffffffffc0205350:	0ee78b63          	beq	a5,a4,ffffffffc0205446 <do_exit+0x124>
    struct mm_struct *mm = current->mm;
ffffffffc0205354:	0287b983          	ld	s3,40(a5)
ffffffffc0205358:	892a                	mv	s2,a0
    if (mm != NULL) {
ffffffffc020535a:	02098663          	beqz	s3,ffffffffc0205386 <do_exit+0x64>
ffffffffc020535e:	000ad797          	auipc	a5,0xad
ffffffffc0205362:	5127b783          	ld	a5,1298(a5) # ffffffffc02b2870 <boot_cr3>
ffffffffc0205366:	577d                	li	a4,-1
ffffffffc0205368:	177e                	slli	a4,a4,0x3f
ffffffffc020536a:	83b1                	srli	a5,a5,0xc
ffffffffc020536c:	8fd9                	or	a5,a5,a4
ffffffffc020536e:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc0205372:	0309a783          	lw	a5,48(s3)
ffffffffc0205376:	fff7871b          	addiw	a4,a5,-1
ffffffffc020537a:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc020537e:	cb55                	beqz	a4,ffffffffc0205432 <do_exit+0x110>
        current->mm = NULL;
ffffffffc0205380:	601c                	ld	a5,0(s0)
ffffffffc0205382:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc0205386:	601c                	ld	a5,0(s0)
ffffffffc0205388:	470d                	li	a4,3
ffffffffc020538a:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc020538c:	0f27a423          	sw	s2,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205390:	100027f3          	csrr	a5,sstatus
ffffffffc0205394:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205396:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205398:	e3f9                	bnez	a5,ffffffffc020545e <do_exit+0x13c>
        proc = current->parent;
ffffffffc020539a:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD) {
ffffffffc020539c:	800007b7          	lui	a5,0x80000
ffffffffc02053a0:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc02053a2:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD) {
ffffffffc02053a4:	0ec52703          	lw	a4,236(a0)
ffffffffc02053a8:	0af70f63          	beq	a4,a5,ffffffffc0205466 <do_exit+0x144>
        while (current->cptr != NULL) {
ffffffffc02053ac:	6018                	ld	a4,0(s0)
ffffffffc02053ae:	7b7c                	ld	a5,240(a4)
ffffffffc02053b0:	c3a1                	beqz	a5,ffffffffc02053f0 <do_exit+0xce>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc02053b2:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02053b6:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD) {
ffffffffc02053b8:	0985                	addi	s3,s3,1
ffffffffc02053ba:	a021                	j	ffffffffc02053c2 <do_exit+0xa0>
        while (current->cptr != NULL) {
ffffffffc02053bc:	6018                	ld	a4,0(s0)
ffffffffc02053be:	7b7c                	ld	a5,240(a4)
ffffffffc02053c0:	cb85                	beqz	a5,ffffffffc02053f0 <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc02053c2:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fd0>
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc02053c6:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc02053c8:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc02053ca:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc02053cc:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc02053d0:	10e7b023          	sd	a4,256(a5)
ffffffffc02053d4:	c311                	beqz	a4,ffffffffc02053d8 <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc02053d6:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02053d8:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc02053da:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc02053dc:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02053de:	fd271fe3          	bne	a4,s2,ffffffffc02053bc <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc02053e2:	0ec52783          	lw	a5,236(a0)
ffffffffc02053e6:	fd379be3          	bne	a5,s3,ffffffffc02053bc <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc02053ea:	373000ef          	jal	ra,ffffffffc0205f5c <wakeup_proc>
ffffffffc02053ee:	b7f9                	j	ffffffffc02053bc <do_exit+0x9a>
    if (flag) {
ffffffffc02053f0:	020a1263          	bnez	s4,ffffffffc0205414 <do_exit+0xf2>
    schedule();
ffffffffc02053f4:	3e9000ef          	jal	ra,ffffffffc0205fdc <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc02053f8:	601c                	ld	a5,0(s0)
ffffffffc02053fa:	00003617          	auipc	a2,0x3
ffffffffc02053fe:	0a660613          	addi	a2,a2,166 # ffffffffc02084a0 <default_pmm_manager+0x1158>
ffffffffc0205402:	20d00593          	li	a1,525
ffffffffc0205406:	43d4                	lw	a3,4(a5)
ffffffffc0205408:	00003517          	auipc	a0,0x3
ffffffffc020540c:	03850513          	addi	a0,a0,56 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205410:	86afb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_enable();
ffffffffc0205414:	a2cfb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc0205418:	bff1                	j	ffffffffc02053f4 <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc020541a:	00003617          	auipc	a2,0x3
ffffffffc020541e:	06660613          	addi	a2,a2,102 # ffffffffc0208480 <default_pmm_manager+0x1138>
ffffffffc0205422:	1e100593          	li	a1,481
ffffffffc0205426:	00003517          	auipc	a0,0x3
ffffffffc020542a:	01a50513          	addi	a0,a0,26 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc020542e:	84cfb0ef          	jal	ra,ffffffffc020047a <__panic>
            exit_mmap(mm);
ffffffffc0205432:	854e                	mv	a0,s3
ffffffffc0205434:	80eff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc0205438:	854e                	mv	a0,s3
ffffffffc020543a:	9d5ff0ef          	jal	ra,ffffffffc0204e0e <put_pgdir>
            mm_destroy(mm);
ffffffffc020543e:	854e                	mv	a0,s3
ffffffffc0205440:	e67fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc0205444:	bf35                	j	ffffffffc0205380 <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc0205446:	00003617          	auipc	a2,0x3
ffffffffc020544a:	04a60613          	addi	a2,a2,74 # ffffffffc0208490 <default_pmm_manager+0x1148>
ffffffffc020544e:	1e400593          	li	a1,484
ffffffffc0205452:	00003517          	auipc	a0,0x3
ffffffffc0205456:	fee50513          	addi	a0,a0,-18 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc020545a:	820fb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_disable();
ffffffffc020545e:	9e8fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0205462:	4a05                	li	s4,1
ffffffffc0205464:	bf1d                	j	ffffffffc020539a <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc0205466:	2f7000ef          	jal	ra,ffffffffc0205f5c <wakeup_proc>
ffffffffc020546a:	b789                	j	ffffffffc02053ac <do_exit+0x8a>

ffffffffc020546c <do_wait.part.0>:
do_wait(int pid, int *code_store) {
ffffffffc020546c:	715d                	addi	sp,sp,-80
ffffffffc020546e:	f84a                	sd	s2,48(sp)
ffffffffc0205470:	f44e                	sd	s3,40(sp)
        current->wait_state = WT_CHILD;
ffffffffc0205472:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205476:	6989                	lui	s3,0x2
do_wait(int pid, int *code_store) {
ffffffffc0205478:	fc26                	sd	s1,56(sp)
ffffffffc020547a:	f052                	sd	s4,32(sp)
ffffffffc020547c:	ec56                	sd	s5,24(sp)
ffffffffc020547e:	e85a                	sd	s6,16(sp)
ffffffffc0205480:	e45e                	sd	s7,8(sp)
ffffffffc0205482:	e486                	sd	ra,72(sp)
ffffffffc0205484:	e0a2                	sd	s0,64(sp)
ffffffffc0205486:	84aa                	mv	s1,a0
ffffffffc0205488:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc020548a:	000adb97          	auipc	s7,0xad
ffffffffc020548e:	43eb8b93          	addi	s7,s7,1086 # ffffffffc02b28c8 <current>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205492:	00050b1b          	sext.w	s6,a0
ffffffffc0205496:	fff50a9b          	addiw	s5,a0,-1
ffffffffc020549a:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc020549c:	0905                	addi	s2,s2,1
    if (pid != 0) {
ffffffffc020549e:	ccbd                	beqz	s1,ffffffffc020551c <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID) {
ffffffffc02054a0:	0359e863          	bltu	s3,s5,ffffffffc02054d0 <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02054a4:	45a9                	li	a1,10
ffffffffc02054a6:	855a                	mv	a0,s6
ffffffffc02054a8:	4a1000ef          	jal	ra,ffffffffc0206148 <hash32>
ffffffffc02054ac:	02051793          	slli	a5,a0,0x20
ffffffffc02054b0:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02054b4:	000a9797          	auipc	a5,0xa9
ffffffffc02054b8:	38c78793          	addi	a5,a5,908 # ffffffffc02ae840 <hash_list>
ffffffffc02054bc:	953e                	add	a0,a0,a5
ffffffffc02054be:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list) {
ffffffffc02054c0:	a029                	j	ffffffffc02054ca <do_wait.part.0+0x5e>
            if (proc->pid == pid) {
ffffffffc02054c2:	f2c42783          	lw	a5,-212(s0)
ffffffffc02054c6:	02978163          	beq	a5,s1,ffffffffc02054e8 <do_wait.part.0+0x7c>
ffffffffc02054ca:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list) {
ffffffffc02054cc:	fe851be3          	bne	a0,s0,ffffffffc02054c2 <do_wait.part.0+0x56>
    return -E_BAD_PROC;
ffffffffc02054d0:	5579                	li	a0,-2
}
ffffffffc02054d2:	60a6                	ld	ra,72(sp)
ffffffffc02054d4:	6406                	ld	s0,64(sp)
ffffffffc02054d6:	74e2                	ld	s1,56(sp)
ffffffffc02054d8:	7942                	ld	s2,48(sp)
ffffffffc02054da:	79a2                	ld	s3,40(sp)
ffffffffc02054dc:	7a02                	ld	s4,32(sp)
ffffffffc02054de:	6ae2                	ld	s5,24(sp)
ffffffffc02054e0:	6b42                	ld	s6,16(sp)
ffffffffc02054e2:	6ba2                	ld	s7,8(sp)
ffffffffc02054e4:	6161                	addi	sp,sp,80
ffffffffc02054e6:	8082                	ret
        if (proc != NULL && proc->parent == current) {
ffffffffc02054e8:	000bb683          	ld	a3,0(s7)
ffffffffc02054ec:	f4843783          	ld	a5,-184(s0)
ffffffffc02054f0:	fed790e3          	bne	a5,a3,ffffffffc02054d0 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054f4:	f2842703          	lw	a4,-216(s0)
ffffffffc02054f8:	478d                	li	a5,3
ffffffffc02054fa:	0ef70b63          	beq	a4,a5,ffffffffc02055f0 <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc02054fe:	4785                	li	a5,1
ffffffffc0205500:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc0205502:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc0205506:	2d7000ef          	jal	ra,ffffffffc0205fdc <schedule>
        if (current->flags & PF_EXITING) {
ffffffffc020550a:	000bb783          	ld	a5,0(s7)
ffffffffc020550e:	0b07a783          	lw	a5,176(a5)
ffffffffc0205512:	8b85                	andi	a5,a5,1
ffffffffc0205514:	d7c9                	beqz	a5,ffffffffc020549e <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc0205516:	555d                	li	a0,-9
ffffffffc0205518:	e0bff0ef          	jal	ra,ffffffffc0205322 <do_exit>
        proc = current->cptr;
ffffffffc020551c:	000bb683          	ld	a3,0(s7)
ffffffffc0205520:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr) {
ffffffffc0205522:	d45d                	beqz	s0,ffffffffc02054d0 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205524:	470d                	li	a4,3
ffffffffc0205526:	a021                	j	ffffffffc020552e <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr) {
ffffffffc0205528:	10043403          	ld	s0,256(s0)
ffffffffc020552c:	d869                	beqz	s0,ffffffffc02054fe <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020552e:	401c                	lw	a5,0(s0)
ffffffffc0205530:	fee79ce3          	bne	a5,a4,ffffffffc0205528 <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc) {
ffffffffc0205534:	000ad797          	auipc	a5,0xad
ffffffffc0205538:	39c7b783          	ld	a5,924(a5) # ffffffffc02b28d0 <idleproc>
ffffffffc020553c:	0c878963          	beq	a5,s0,ffffffffc020560e <do_wait.part.0+0x1a2>
ffffffffc0205540:	000ad797          	auipc	a5,0xad
ffffffffc0205544:	3987b783          	ld	a5,920(a5) # ffffffffc02b28d8 <initproc>
ffffffffc0205548:	0cf40363          	beq	s0,a5,ffffffffc020560e <do_wait.part.0+0x1a2>
    if (code_store != NULL) {
ffffffffc020554c:	000a0663          	beqz	s4,ffffffffc0205558 <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc0205550:	0e842783          	lw	a5,232(s0)
ffffffffc0205554:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8bb8>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205558:	100027f3          	csrr	a5,sstatus
ffffffffc020555c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020555e:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205560:	e7c1                	bnez	a5,ffffffffc02055e8 <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
ffffffffc0205562:	6c70                	ld	a2,216(s0)
ffffffffc0205564:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL) {
ffffffffc0205566:	10043703          	ld	a4,256(s0)
        proc->optr->yptr = proc->yptr;
ffffffffc020556a:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc020556c:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc020556e:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc0205570:	6470                	ld	a2,200(s0)
ffffffffc0205572:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc0205574:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0205576:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL) {
ffffffffc0205578:	c319                	beqz	a4,ffffffffc020557e <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc020557a:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL) {
ffffffffc020557c:	7c7c                	ld	a5,248(s0)
ffffffffc020557e:	c3b5                	beqz	a5,ffffffffc02055e2 <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc0205580:	10e7b023          	sd	a4,256(a5)
    nr_process --;
ffffffffc0205584:	000ad717          	auipc	a4,0xad
ffffffffc0205588:	35c70713          	addi	a4,a4,860 # ffffffffc02b28e0 <nr_process>
ffffffffc020558c:	431c                	lw	a5,0(a4)
ffffffffc020558e:	37fd                	addiw	a5,a5,-1
ffffffffc0205590:	c31c                	sw	a5,0(a4)
    if (flag) {
ffffffffc0205592:	e5a9                	bnez	a1,ffffffffc02055dc <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0205594:	6814                	ld	a3,16(s0)
    return pa2page(PADDR(kva));
ffffffffc0205596:	c02007b7          	lui	a5,0xc0200
ffffffffc020559a:	04f6ee63          	bltu	a3,a5,ffffffffc02055f6 <do_wait.part.0+0x18a>
ffffffffc020559e:	000ad797          	auipc	a5,0xad
ffffffffc02055a2:	2fa7b783          	ld	a5,762(a5) # ffffffffc02b2898 <va_pa_offset>
ffffffffc02055a6:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02055a8:	82b1                	srli	a3,a3,0xc
ffffffffc02055aa:	000ad797          	auipc	a5,0xad
ffffffffc02055ae:	2d67b783          	ld	a5,726(a5) # ffffffffc02b2880 <npage>
ffffffffc02055b2:	06f6fa63          	bgeu	a3,a5,ffffffffc0205626 <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc02055b6:	00003517          	auipc	a0,0x3
ffffffffc02055ba:	72253503          	ld	a0,1826(a0) # ffffffffc0208cd8 <nbase>
ffffffffc02055be:	8e89                	sub	a3,a3,a0
ffffffffc02055c0:	069a                	slli	a3,a3,0x6
ffffffffc02055c2:	000ad517          	auipc	a0,0xad
ffffffffc02055c6:	2c653503          	ld	a0,710(a0) # ffffffffc02b2888 <pages>
ffffffffc02055ca:	9536                	add	a0,a0,a3
ffffffffc02055cc:	4589                	li	a1,2
ffffffffc02055ce:	fa4fc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc02055d2:	8522                	mv	a0,s0
ffffffffc02055d4:	ddefc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    return 0;
ffffffffc02055d8:	4501                	li	a0,0
ffffffffc02055da:	bde5                	j	ffffffffc02054d2 <do_wait.part.0+0x66>
        intr_enable();
ffffffffc02055dc:	864fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02055e0:	bf55                	j	ffffffffc0205594 <do_wait.part.0+0x128>
       proc->parent->cptr = proc->optr;
ffffffffc02055e2:	701c                	ld	a5,32(s0)
ffffffffc02055e4:	fbf8                	sd	a4,240(a5)
ffffffffc02055e6:	bf79                	j	ffffffffc0205584 <do_wait.part.0+0x118>
        intr_disable();
ffffffffc02055e8:	85efb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc02055ec:	4585                	li	a1,1
ffffffffc02055ee:	bf95                	j	ffffffffc0205562 <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02055f0:	f2840413          	addi	s0,s0,-216
ffffffffc02055f4:	b781                	j	ffffffffc0205534 <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc02055f6:	00002617          	auipc	a2,0x2
ffffffffc02055fa:	e3260613          	addi	a2,a2,-462 # ffffffffc0207428 <default_pmm_manager+0xe0>
ffffffffc02055fe:	06e00593          	li	a1,110
ffffffffc0205602:	00002517          	auipc	a0,0x2
ffffffffc0205606:	da650513          	addi	a0,a0,-602 # ffffffffc02073a8 <default_pmm_manager+0x60>
ffffffffc020560a:	e71fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc020560e:	00003617          	auipc	a2,0x3
ffffffffc0205612:	eb260613          	addi	a2,a2,-334 # ffffffffc02084c0 <default_pmm_manager+0x1178>
ffffffffc0205616:	30700593          	li	a1,775
ffffffffc020561a:	00003517          	auipc	a0,0x3
ffffffffc020561e:	e2650513          	addi	a0,a0,-474 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205622:	e59fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205626:	00002617          	auipc	a2,0x2
ffffffffc020562a:	e2a60613          	addi	a2,a2,-470 # ffffffffc0207450 <default_pmm_manager+0x108>
ffffffffc020562e:	06200593          	li	a1,98
ffffffffc0205632:	00002517          	auipc	a0,0x2
ffffffffc0205636:	d7650513          	addi	a0,a0,-650 # ffffffffc02073a8 <default_pmm_manager+0x60>
ffffffffc020563a:	e41fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc020563e <init_main>:
}

// init_main - the second kernel thread used to create user_main kernel threads
static int
init_main(void *arg) {
ffffffffc020563e:	1141                	addi	sp,sp,-16
ffffffffc0205640:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0205642:	f70fc0ef          	jal	ra,ffffffffc0201db2 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc0205646:	cb8fc0ef          	jal	ra,ffffffffc0201afe <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc020564a:	4601                	li	a2,0
ffffffffc020564c:	4581                	li	a1,0
ffffffffc020564e:	fffff517          	auipc	a0,0xfffff
ffffffffc0205652:	74250513          	addi	a0,a0,1858 # ffffffffc0204d90 <user_main>
ffffffffc0205656:	c7dff0ef          	jal	ra,ffffffffc02052d2 <kernel_thread>
    if (pid <= 0) {
ffffffffc020565a:	00a04563          	bgtz	a0,ffffffffc0205664 <init_main+0x26>
ffffffffc020565e:	a071                	j	ffffffffc02056ea <init_main+0xac>
        panic("create user_main failed.\n");
    }

    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc0205660:	17d000ef          	jal	ra,ffffffffc0205fdc <schedule>
    if (code_store != NULL) {
ffffffffc0205664:	4581                	li	a1,0
ffffffffc0205666:	4501                	li	a0,0
ffffffffc0205668:	e05ff0ef          	jal	ra,ffffffffc020546c <do_wait.part.0>
    while (do_wait(0, NULL) == 0) {
ffffffffc020566c:	d975                	beqz	a0,ffffffffc0205660 <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc020566e:	00003517          	auipc	a0,0x3
ffffffffc0205672:	e9250513          	addi	a0,a0,-366 # ffffffffc0208500 <default_pmm_manager+0x11b8>
ffffffffc0205676:	b0bfa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc020567a:	000ad797          	auipc	a5,0xad
ffffffffc020567e:	25e7b783          	ld	a5,606(a5) # ffffffffc02b28d8 <initproc>
ffffffffc0205682:	7bf8                	ld	a4,240(a5)
ffffffffc0205684:	e339                	bnez	a4,ffffffffc02056ca <init_main+0x8c>
ffffffffc0205686:	7ff8                	ld	a4,248(a5)
ffffffffc0205688:	e329                	bnez	a4,ffffffffc02056ca <init_main+0x8c>
ffffffffc020568a:	1007b703          	ld	a4,256(a5)
ffffffffc020568e:	ef15                	bnez	a4,ffffffffc02056ca <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc0205690:	000ad697          	auipc	a3,0xad
ffffffffc0205694:	2506a683          	lw	a3,592(a3) # ffffffffc02b28e0 <nr_process>
ffffffffc0205698:	4709                	li	a4,2
ffffffffc020569a:	0ae69463          	bne	a3,a4,ffffffffc0205742 <init_main+0x104>
    return listelm->next;
ffffffffc020569e:	000ad697          	auipc	a3,0xad
ffffffffc02056a2:	1a268693          	addi	a3,a3,418 # ffffffffc02b2840 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02056a6:	6698                	ld	a4,8(a3)
ffffffffc02056a8:	0c878793          	addi	a5,a5,200
ffffffffc02056ac:	06f71b63          	bne	a4,a5,ffffffffc0205722 <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02056b0:	629c                	ld	a5,0(a3)
ffffffffc02056b2:	04f71863          	bne	a4,a5,ffffffffc0205702 <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc02056b6:	00003517          	auipc	a0,0x3
ffffffffc02056ba:	f3250513          	addi	a0,a0,-206 # ffffffffc02085e8 <default_pmm_manager+0x12a0>
ffffffffc02056be:	ac3fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc02056c2:	60a2                	ld	ra,8(sp)
ffffffffc02056c4:	4501                	li	a0,0
ffffffffc02056c6:	0141                	addi	sp,sp,16
ffffffffc02056c8:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc02056ca:	00003697          	auipc	a3,0x3
ffffffffc02056ce:	e5e68693          	addi	a3,a3,-418 # ffffffffc0208528 <default_pmm_manager+0x11e0>
ffffffffc02056d2:	00001617          	auipc	a2,0x1
ffffffffc02056d6:	5de60613          	addi	a2,a2,1502 # ffffffffc0206cb0 <commands+0x450>
ffffffffc02056da:	36c00593          	li	a1,876
ffffffffc02056de:	00003517          	auipc	a0,0x3
ffffffffc02056e2:	d6250513          	addi	a0,a0,-670 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc02056e6:	d95fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("create user_main failed.\n");
ffffffffc02056ea:	00003617          	auipc	a2,0x3
ffffffffc02056ee:	df660613          	addi	a2,a2,-522 # ffffffffc02084e0 <default_pmm_manager+0x1198>
ffffffffc02056f2:	36400593          	li	a1,868
ffffffffc02056f6:	00003517          	auipc	a0,0x3
ffffffffc02056fa:	d4a50513          	addi	a0,a0,-694 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc02056fe:	d7dfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc0205702:	00003697          	auipc	a3,0x3
ffffffffc0205706:	eb668693          	addi	a3,a3,-330 # ffffffffc02085b8 <default_pmm_manager+0x1270>
ffffffffc020570a:	00001617          	auipc	a2,0x1
ffffffffc020570e:	5a660613          	addi	a2,a2,1446 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205712:	36f00593          	li	a1,879
ffffffffc0205716:	00003517          	auipc	a0,0x3
ffffffffc020571a:	d2a50513          	addi	a0,a0,-726 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc020571e:	d5dfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc0205722:	00003697          	auipc	a3,0x3
ffffffffc0205726:	e6668693          	addi	a3,a3,-410 # ffffffffc0208588 <default_pmm_manager+0x1240>
ffffffffc020572a:	00001617          	auipc	a2,0x1
ffffffffc020572e:	58660613          	addi	a2,a2,1414 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205732:	36e00593          	li	a1,878
ffffffffc0205736:	00003517          	auipc	a0,0x3
ffffffffc020573a:	d0a50513          	addi	a0,a0,-758 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc020573e:	d3dfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_process == 2);
ffffffffc0205742:	00003697          	auipc	a3,0x3
ffffffffc0205746:	e3668693          	addi	a3,a3,-458 # ffffffffc0208578 <default_pmm_manager+0x1230>
ffffffffc020574a:	00001617          	auipc	a2,0x1
ffffffffc020574e:	56660613          	addi	a2,a2,1382 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205752:	36d00593          	li	a1,877
ffffffffc0205756:	00003517          	auipc	a0,0x3
ffffffffc020575a:	cea50513          	addi	a0,a0,-790 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc020575e:	d1dfa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205762 <do_execve>:
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205762:	7171                	addi	sp,sp,-176
ffffffffc0205764:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0205766:	000add97          	auipc	s11,0xad
ffffffffc020576a:	162d8d93          	addi	s11,s11,354 # ffffffffc02b28c8 <current>
ffffffffc020576e:	000db783          	ld	a5,0(s11)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205772:	e54e                	sd	s3,136(sp)
ffffffffc0205774:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0205776:	0287b983          	ld	s3,40(a5)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020577a:	e94a                	sd	s2,144(sp)
ffffffffc020577c:	f4de                	sd	s7,104(sp)
ffffffffc020577e:	892a                	mv	s2,a0
ffffffffc0205780:	8bb2                	mv	s7,a2
ffffffffc0205782:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205784:	862e                	mv	a2,a1
ffffffffc0205786:	4681                	li	a3,0
ffffffffc0205788:	85aa                	mv	a1,a0
ffffffffc020578a:	854e                	mv	a0,s3
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020578c:	f506                	sd	ra,168(sp)
ffffffffc020578e:	f122                	sd	s0,160(sp)
ffffffffc0205790:	e152                	sd	s4,128(sp)
ffffffffc0205792:	fcd6                	sd	s5,120(sp)
ffffffffc0205794:	f8da                	sd	s6,112(sp)
ffffffffc0205796:	f0e2                	sd	s8,96(sp)
ffffffffc0205798:	ece6                	sd	s9,88(sp)
ffffffffc020579a:	e8ea                	sd	s10,80(sp)
ffffffffc020579c:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc020579e:	b82ff0ef          	jal	ra,ffffffffc0204b20 <user_mem_check>
ffffffffc02057a2:	40050a63          	beqz	a0,ffffffffc0205bb6 <do_execve+0x454>
    memset(local_name, 0, sizeof(local_name));
ffffffffc02057a6:	4641                	li	a2,16
ffffffffc02057a8:	4581                	li	a1,0
ffffffffc02057aa:	1808                	addi	a0,sp,48
ffffffffc02057ac:	61d000ef          	jal	ra,ffffffffc02065c8 <memset>
    memcpy(local_name, name, len);
ffffffffc02057b0:	47bd                	li	a5,15
ffffffffc02057b2:	8626                	mv	a2,s1
ffffffffc02057b4:	1e97e263          	bltu	a5,s1,ffffffffc0205998 <do_execve+0x236>
ffffffffc02057b8:	85ca                	mv	a1,s2
ffffffffc02057ba:	1808                	addi	a0,sp,48
ffffffffc02057bc:	61f000ef          	jal	ra,ffffffffc02065da <memcpy>
    if (mm != NULL) {
ffffffffc02057c0:	1e098363          	beqz	s3,ffffffffc02059a6 <do_execve+0x244>
        cputs("mm != NULL");
ffffffffc02057c4:	00002517          	auipc	a0,0x2
ffffffffc02057c8:	30c50513          	addi	a0,a0,780 # ffffffffc0207ad0 <default_pmm_manager+0x788>
ffffffffc02057cc:	9edfa0ef          	jal	ra,ffffffffc02001b8 <cputs>
ffffffffc02057d0:	000ad797          	auipc	a5,0xad
ffffffffc02057d4:	0a07b783          	ld	a5,160(a5) # ffffffffc02b2870 <boot_cr3>
ffffffffc02057d8:	577d                	li	a4,-1
ffffffffc02057da:	177e                	slli	a4,a4,0x3f
ffffffffc02057dc:	83b1                	srli	a5,a5,0xc
ffffffffc02057de:	8fd9                	or	a5,a5,a4
ffffffffc02057e0:	18079073          	csrw	satp,a5
ffffffffc02057e4:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7b88>
ffffffffc02057e8:	fff7871b          	addiw	a4,a5,-1
ffffffffc02057ec:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc02057f0:	2c070463          	beqz	a4,ffffffffc0205ab8 <do_execve+0x356>
        current->mm = NULL;
ffffffffc02057f4:	000db783          	ld	a5,0(s11)
ffffffffc02057f8:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL) {
ffffffffc02057fc:	925fe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc0205800:	84aa                	mv	s1,a0
ffffffffc0205802:	1c050d63          	beqz	a0,ffffffffc02059dc <do_execve+0x27a>
    if ((page = alloc_page()) == NULL) {
ffffffffc0205806:	4505                	li	a0,1
ffffffffc0205808:	cd8fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc020580c:	3a050963          	beqz	a0,ffffffffc0205bbe <do_execve+0x45c>
    return page - pages + nbase;
ffffffffc0205810:	000adc97          	auipc	s9,0xad
ffffffffc0205814:	078c8c93          	addi	s9,s9,120 # ffffffffc02b2888 <pages>
ffffffffc0205818:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc020581c:	000adc17          	auipc	s8,0xad
ffffffffc0205820:	064c0c13          	addi	s8,s8,100 # ffffffffc02b2880 <npage>
    return page - pages + nbase;
ffffffffc0205824:	00003717          	auipc	a4,0x3
ffffffffc0205828:	4b473703          	ld	a4,1204(a4) # ffffffffc0208cd8 <nbase>
ffffffffc020582c:	40d506b3          	sub	a3,a0,a3
ffffffffc0205830:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0205832:	5afd                	li	s5,-1
ffffffffc0205834:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc0205838:	96ba                	add	a3,a3,a4
ffffffffc020583a:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc020583c:	00cad713          	srli	a4,s5,0xc
ffffffffc0205840:	ec3a                	sd	a4,24(sp)
ffffffffc0205842:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc0205844:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205846:	38f77063          	bgeu	a4,a5,ffffffffc0205bc6 <do_execve+0x464>
ffffffffc020584a:	000adb17          	auipc	s6,0xad
ffffffffc020584e:	04eb0b13          	addi	s6,s6,78 # ffffffffc02b2898 <va_pa_offset>
ffffffffc0205852:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0205856:	6605                	lui	a2,0x1
ffffffffc0205858:	000ad597          	auipc	a1,0xad
ffffffffc020585c:	0205b583          	ld	a1,32(a1) # ffffffffc02b2878 <boot_pgdir>
ffffffffc0205860:	9936                	add	s2,s2,a3
ffffffffc0205862:	854a                	mv	a0,s2
ffffffffc0205864:	577000ef          	jal	ra,ffffffffc02065da <memcpy>
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205868:	7782                	ld	a5,32(sp)
ffffffffc020586a:	4398                	lw	a4,0(a5)
ffffffffc020586c:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc0205870:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205874:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b944f>
ffffffffc0205878:	14f71863          	bne	a4,a5,ffffffffc02059c8 <do_execve+0x266>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020587c:	7682                	ld	a3,32(sp)
ffffffffc020587e:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0205882:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205886:	00371793          	slli	a5,a4,0x3
ffffffffc020588a:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc020588c:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020588e:	078e                	slli	a5,a5,0x3
ffffffffc0205890:	97ce                	add	a5,a5,s3
ffffffffc0205892:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph ++) {
ffffffffc0205894:	00f9fc63          	bgeu	s3,a5,ffffffffc02058ac <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD) {
ffffffffc0205898:	0009a783          	lw	a5,0(s3)
ffffffffc020589c:	4705                	li	a4,1
ffffffffc020589e:	14e78163          	beq	a5,a4,ffffffffc02059e0 <do_execve+0x27e>
    for (; ph < ph_end; ph ++) {
ffffffffc02058a2:	77a2                	ld	a5,40(sp)
ffffffffc02058a4:	03898993          	addi	s3,s3,56
ffffffffc02058a8:	fef9e8e3          	bltu	s3,a5,ffffffffc0205898 <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0) {
ffffffffc02058ac:	4701                	li	a4,0
ffffffffc02058ae:	46ad                	li	a3,11
ffffffffc02058b0:	00100637          	lui	a2,0x100
ffffffffc02058b4:	7ff005b7          	lui	a1,0x7ff00
ffffffffc02058b8:	8526                	mv	a0,s1
ffffffffc02058ba:	a3ffe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc02058be:	892a                	mv	s2,a0
ffffffffc02058c0:	1e051263          	bnez	a0,ffffffffc0205aa4 <do_execve+0x342>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc02058c4:	6c88                	ld	a0,24(s1)
ffffffffc02058c6:	467d                	li	a2,31
ffffffffc02058c8:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc02058cc:	a81fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058d0:	38050363          	beqz	a0,ffffffffc0205c56 <do_execve+0x4f4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc02058d4:	6c88                	ld	a0,24(s1)
ffffffffc02058d6:	467d                	li	a2,31
ffffffffc02058d8:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc02058dc:	a71fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058e0:	34050b63          	beqz	a0,ffffffffc0205c36 <do_execve+0x4d4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc02058e4:	6c88                	ld	a0,24(s1)
ffffffffc02058e6:	467d                	li	a2,31
ffffffffc02058e8:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc02058ec:	a61fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058f0:	32050363          	beqz	a0,ffffffffc0205c16 <do_execve+0x4b4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc02058f4:	6c88                	ld	a0,24(s1)
ffffffffc02058f6:	467d                	li	a2,31
ffffffffc02058f8:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc02058fc:	a51fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205900:	2e050b63          	beqz	a0,ffffffffc0205bf6 <do_execve+0x494>
    mm->mm_count += 1;
ffffffffc0205904:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc0205906:	000db603          	ld	a2,0(s11)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc020590a:	6c94                	ld	a3,24(s1)
ffffffffc020590c:	2785                	addiw	a5,a5,1
ffffffffc020590e:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc0205910:	f604                	sd	s1,40(a2)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205912:	c02007b7          	lui	a5,0xc0200
ffffffffc0205916:	2cf6e463          	bltu	a3,a5,ffffffffc0205bde <do_execve+0x47c>
ffffffffc020591a:	000b3783          	ld	a5,0(s6)
ffffffffc020591e:	577d                	li	a4,-1
ffffffffc0205920:	177e                	slli	a4,a4,0x3f
ffffffffc0205922:	8e9d                	sub	a3,a3,a5
ffffffffc0205924:	00c6d793          	srli	a5,a3,0xc
ffffffffc0205928:	f654                	sd	a3,168(a2)
ffffffffc020592a:	8fd9                	or	a5,a5,a4
ffffffffc020592c:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc0205930:	7244                	ld	s1,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc0205932:	4581                	li	a1,0
ffffffffc0205934:	12000613          	li	a2,288
ffffffffc0205938:	8526                	mv	a0,s1
ffffffffc020593a:	48f000ef          	jal	ra,ffffffffc02065c8 <memset>
    tf -> epc = elf -> e_entry;
ffffffffc020593e:	7782                	ld	a5,32(sp)
ffffffffc0205940:	6f98                	ld	a4,24(a5)
    tf -> gpr.sp = USTACKTOP;
ffffffffc0205942:	4785                	li	a5,1
ffffffffc0205944:	07fe                	slli	a5,a5,0x1f
ffffffffc0205946:	e89c                	sd	a5,16(s1)
    tf -> epc = elf -> e_entry;
ffffffffc0205948:	10e4b423          	sd	a4,264(s1)
    tf -> status = (read_csr(sstatus) & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc020594c:	100027f3          	csrr	a5,sstatus
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205950:	000db403          	ld	s0,0(s11)
    tf -> status = (read_csr(sstatus) & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0205954:	edf7f793          	andi	a5,a5,-289
ffffffffc0205958:	0207e793          	ori	a5,a5,32
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020595c:	0b440413          	addi	s0,s0,180
ffffffffc0205960:	4641                	li	a2,16
ffffffffc0205962:	4581                	li	a1,0
    tf -> status = (read_csr(sstatus) & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0205964:	10f4b023          	sd	a5,256(s1)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205968:	8522                	mv	a0,s0
ffffffffc020596a:	45f000ef          	jal	ra,ffffffffc02065c8 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020596e:	463d                	li	a2,15
ffffffffc0205970:	180c                	addi	a1,sp,48
ffffffffc0205972:	8522                	mv	a0,s0
ffffffffc0205974:	467000ef          	jal	ra,ffffffffc02065da <memcpy>
}
ffffffffc0205978:	70aa                	ld	ra,168(sp)
ffffffffc020597a:	740a                	ld	s0,160(sp)
ffffffffc020597c:	64ea                	ld	s1,152(sp)
ffffffffc020597e:	69aa                	ld	s3,136(sp)
ffffffffc0205980:	6a0a                	ld	s4,128(sp)
ffffffffc0205982:	7ae6                	ld	s5,120(sp)
ffffffffc0205984:	7b46                	ld	s6,112(sp)
ffffffffc0205986:	7ba6                	ld	s7,104(sp)
ffffffffc0205988:	7c06                	ld	s8,96(sp)
ffffffffc020598a:	6ce6                	ld	s9,88(sp)
ffffffffc020598c:	6d46                	ld	s10,80(sp)
ffffffffc020598e:	6da6                	ld	s11,72(sp)
ffffffffc0205990:	854a                	mv	a0,s2
ffffffffc0205992:	694a                	ld	s2,144(sp)
ffffffffc0205994:	614d                	addi	sp,sp,176
ffffffffc0205996:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc0205998:	463d                	li	a2,15
ffffffffc020599a:	85ca                	mv	a1,s2
ffffffffc020599c:	1808                	addi	a0,sp,48
ffffffffc020599e:	43d000ef          	jal	ra,ffffffffc02065da <memcpy>
    if (mm != NULL) {
ffffffffc02059a2:	e20991e3          	bnez	s3,ffffffffc02057c4 <do_execve+0x62>
    if (current->mm != NULL) {
ffffffffc02059a6:	000db783          	ld	a5,0(s11)
ffffffffc02059aa:	779c                	ld	a5,40(a5)
ffffffffc02059ac:	e40788e3          	beqz	a5,ffffffffc02057fc <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc02059b0:	00003617          	auipc	a2,0x3
ffffffffc02059b4:	c5860613          	addi	a2,a2,-936 # ffffffffc0208608 <default_pmm_manager+0x12c0>
ffffffffc02059b8:	21700593          	li	a1,535
ffffffffc02059bc:	00003517          	auipc	a0,0x3
ffffffffc02059c0:	a8450513          	addi	a0,a0,-1404 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc02059c4:	ab7fa0ef          	jal	ra,ffffffffc020047a <__panic>
    put_pgdir(mm);
ffffffffc02059c8:	8526                	mv	a0,s1
ffffffffc02059ca:	c44ff0ef          	jal	ra,ffffffffc0204e0e <put_pgdir>
    mm_destroy(mm);
ffffffffc02059ce:	8526                	mv	a0,s1
ffffffffc02059d0:	8d7fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc02059d4:	5961                	li	s2,-8
    do_exit(ret);
ffffffffc02059d6:	854a                	mv	a0,s2
ffffffffc02059d8:	94bff0ef          	jal	ra,ffffffffc0205322 <do_exit>
    int ret = -E_NO_MEM;
ffffffffc02059dc:	5971                	li	s2,-4
ffffffffc02059de:	bfe5                	j	ffffffffc02059d6 <do_execve+0x274>
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc02059e0:	0289b603          	ld	a2,40(s3)
ffffffffc02059e4:	0209b783          	ld	a5,32(s3)
ffffffffc02059e8:	1cf66d63          	bltu	a2,a5,ffffffffc0205bc2 <do_execve+0x460>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc02059ec:	0049a783          	lw	a5,4(s3)
ffffffffc02059f0:	0017f693          	andi	a3,a5,1
ffffffffc02059f4:	c291                	beqz	a3,ffffffffc02059f8 <do_execve+0x296>
ffffffffc02059f6:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059f8:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059fc:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059fe:	e779                	bnez	a4,ffffffffc0205acc <do_execve+0x36a>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0205a00:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a02:	c781                	beqz	a5,ffffffffc0205a0a <do_execve+0x2a8>
ffffffffc0205a04:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc0205a08:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205a0a:	0026f793          	andi	a5,a3,2
ffffffffc0205a0e:	e3f1                	bnez	a5,ffffffffc0205ad2 <do_execve+0x370>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc0205a10:	0046f793          	andi	a5,a3,4
ffffffffc0205a14:	c399                	beqz	a5,ffffffffc0205a1a <do_execve+0x2b8>
ffffffffc0205a16:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc0205a1a:	0109b583          	ld	a1,16(s3)
ffffffffc0205a1e:	4701                	li	a4,0
ffffffffc0205a20:	8526                	mv	a0,s1
ffffffffc0205a22:	8d7fe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc0205a26:	892a                	mv	s2,a0
ffffffffc0205a28:	ed35                	bnez	a0,ffffffffc0205aa4 <do_execve+0x342>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a2a:	0109bb83          	ld	s7,16(s3)
ffffffffc0205a2e:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc0205a30:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a34:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a38:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a3c:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc0205a3e:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a40:	993e                	add	s2,s2,a5
        while (start < end) {
ffffffffc0205a42:	054be963          	bltu	s7,s4,ffffffffc0205a94 <do_execve+0x332>
ffffffffc0205a46:	aa95                	j	ffffffffc0205bba <do_execve+0x458>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205a48:	6785                	lui	a5,0x1
ffffffffc0205a4a:	415b8533          	sub	a0,s7,s5
ffffffffc0205a4e:	9abe                	add	s5,s5,a5
ffffffffc0205a50:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205a54:	015a7463          	bgeu	s4,s5,ffffffffc0205a5c <do_execve+0x2fa>
                size -= la - end;
ffffffffc0205a58:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc0205a5c:	000cb683          	ld	a3,0(s9)
ffffffffc0205a60:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205a62:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205a66:	40d406b3          	sub	a3,s0,a3
ffffffffc0205a6a:	8699                	srai	a3,a3,0x6
ffffffffc0205a6c:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205a6e:	67e2                	ld	a5,24(sp)
ffffffffc0205a70:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205a74:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205a76:	14b87863          	bgeu	a6,a1,ffffffffc0205bc6 <do_execve+0x464>
ffffffffc0205a7a:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a7e:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc0205a80:	9bb2                	add	s7,s7,a2
ffffffffc0205a82:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a84:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205a86:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a88:	353000ef          	jal	ra,ffffffffc02065da <memcpy>
            start += size, from += size;
ffffffffc0205a8c:	6622                	ld	a2,8(sp)
ffffffffc0205a8e:	9932                	add	s2,s2,a2
        while (start < end) {
ffffffffc0205a90:	054bf363          	bgeu	s7,s4,ffffffffc0205ad6 <do_execve+0x374>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205a94:	6c88                	ld	a0,24(s1)
ffffffffc0205a96:	866a                	mv	a2,s10
ffffffffc0205a98:	85d6                	mv	a1,s5
ffffffffc0205a9a:	8b3fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a9e:	842a                	mv	s0,a0
ffffffffc0205aa0:	f545                	bnez	a0,ffffffffc0205a48 <do_execve+0x2e6>
        ret = -E_NO_MEM;
ffffffffc0205aa2:	5971                	li	s2,-4
    exit_mmap(mm);
ffffffffc0205aa4:	8526                	mv	a0,s1
ffffffffc0205aa6:	99dfe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc0205aaa:	8526                	mv	a0,s1
ffffffffc0205aac:	b62ff0ef          	jal	ra,ffffffffc0204e0e <put_pgdir>
    mm_destroy(mm);
ffffffffc0205ab0:	8526                	mv	a0,s1
ffffffffc0205ab2:	ff4fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    return ret;
ffffffffc0205ab6:	b705                	j	ffffffffc02059d6 <do_execve+0x274>
            exit_mmap(mm);
ffffffffc0205ab8:	854e                	mv	a0,s3
ffffffffc0205aba:	989fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc0205abe:	854e                	mv	a0,s3
ffffffffc0205ac0:	b4eff0ef          	jal	ra,ffffffffc0204e0e <put_pgdir>
            mm_destroy(mm);
ffffffffc0205ac4:	854e                	mv	a0,s3
ffffffffc0205ac6:	fe0fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc0205aca:	b32d                	j	ffffffffc02057f4 <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205acc:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205ad0:	fb95                	bnez	a5,ffffffffc0205a04 <do_execve+0x2a2>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205ad2:	4d5d                	li	s10,23
ffffffffc0205ad4:	bf35                	j	ffffffffc0205a10 <do_execve+0x2ae>
        end = ph->p_va + ph->p_memsz;
ffffffffc0205ad6:	0109b683          	ld	a3,16(s3)
ffffffffc0205ada:	0289b903          	ld	s2,40(s3)
ffffffffc0205ade:	9936                	add	s2,s2,a3
        if (start < la) {
ffffffffc0205ae0:	075bfd63          	bgeu	s7,s5,ffffffffc0205b5a <do_execve+0x3f8>
            if (start == end) {
ffffffffc0205ae4:	db790fe3          	beq	s2,s7,ffffffffc02058a2 <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205ae8:	6785                	lui	a5,0x1
ffffffffc0205aea:	00fb8533          	add	a0,s7,a5
ffffffffc0205aee:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0205af2:	41790a33          	sub	s4,s2,s7
            if (end < la) {
ffffffffc0205af6:	0b597d63          	bgeu	s2,s5,ffffffffc0205bb0 <do_execve+0x44e>
    return page - pages + nbase;
ffffffffc0205afa:	000cb683          	ld	a3,0(s9)
ffffffffc0205afe:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205b00:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
ffffffffc0205b04:	40d406b3          	sub	a3,s0,a3
ffffffffc0205b08:	8699                	srai	a3,a3,0x6
ffffffffc0205b0a:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205b0c:	67e2                	ld	a5,24(sp)
ffffffffc0205b0e:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b12:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b14:	0ac5f963          	bgeu	a1,a2,ffffffffc0205bc6 <do_execve+0x464>
ffffffffc0205b18:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b1c:	8652                	mv	a2,s4
ffffffffc0205b1e:	4581                	li	a1,0
ffffffffc0205b20:	96c2                	add	a3,a3,a6
ffffffffc0205b22:	9536                	add	a0,a0,a3
ffffffffc0205b24:	2a5000ef          	jal	ra,ffffffffc02065c8 <memset>
            start += size;
ffffffffc0205b28:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205b2c:	03597463          	bgeu	s2,s5,ffffffffc0205b54 <do_execve+0x3f2>
ffffffffc0205b30:	d6e909e3          	beq	s2,a4,ffffffffc02058a2 <do_execve+0x140>
ffffffffc0205b34:	00003697          	auipc	a3,0x3
ffffffffc0205b38:	afc68693          	addi	a3,a3,-1284 # ffffffffc0208630 <default_pmm_manager+0x12e8>
ffffffffc0205b3c:	00001617          	auipc	a2,0x1
ffffffffc0205b40:	17460613          	addi	a2,a2,372 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205b44:	26c00593          	li	a1,620
ffffffffc0205b48:	00003517          	auipc	a0,0x3
ffffffffc0205b4c:	8f850513          	addi	a0,a0,-1800 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205b50:	92bfa0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0205b54:	ff5710e3          	bne	a4,s5,ffffffffc0205b34 <do_execve+0x3d2>
ffffffffc0205b58:	8bd6                	mv	s7,s5
        while (start < end) {
ffffffffc0205b5a:	d52bf4e3          	bgeu	s7,s2,ffffffffc02058a2 <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205b5e:	6c88                	ld	a0,24(s1)
ffffffffc0205b60:	866a                	mv	a2,s10
ffffffffc0205b62:	85d6                	mv	a1,s5
ffffffffc0205b64:	fe8fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205b68:	842a                	mv	s0,a0
ffffffffc0205b6a:	dd05                	beqz	a0,ffffffffc0205aa2 <do_execve+0x340>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205b6c:	6785                	lui	a5,0x1
ffffffffc0205b6e:	415b8533          	sub	a0,s7,s5
ffffffffc0205b72:	9abe                	add	s5,s5,a5
ffffffffc0205b74:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205b78:	01597463          	bgeu	s2,s5,ffffffffc0205b80 <do_execve+0x41e>
                size -= la - end;
ffffffffc0205b7c:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0205b80:	000cb683          	ld	a3,0(s9)
ffffffffc0205b84:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205b86:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205b8a:	40d406b3          	sub	a3,s0,a3
ffffffffc0205b8e:	8699                	srai	a3,a3,0x6
ffffffffc0205b90:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205b92:	67e2                	ld	a5,24(sp)
ffffffffc0205b94:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b98:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b9a:	02b87663          	bgeu	a6,a1,ffffffffc0205bc6 <do_execve+0x464>
ffffffffc0205b9e:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205ba2:	4581                	li	a1,0
            start += size;
ffffffffc0205ba4:	9bb2                	add	s7,s7,a2
ffffffffc0205ba6:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0205ba8:	9536                	add	a0,a0,a3
ffffffffc0205baa:	21f000ef          	jal	ra,ffffffffc02065c8 <memset>
ffffffffc0205bae:	b775                	j	ffffffffc0205b5a <do_execve+0x3f8>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205bb0:	417a8a33          	sub	s4,s5,s7
ffffffffc0205bb4:	b799                	j	ffffffffc0205afa <do_execve+0x398>
        return -E_INVAL;
ffffffffc0205bb6:	5975                	li	s2,-3
ffffffffc0205bb8:	b3c1                	j	ffffffffc0205978 <do_execve+0x216>
        while (start < end) {
ffffffffc0205bba:	86de                	mv	a3,s7
ffffffffc0205bbc:	bf39                	j	ffffffffc0205ada <do_execve+0x378>
    int ret = -E_NO_MEM;
ffffffffc0205bbe:	5971                	li	s2,-4
ffffffffc0205bc0:	bdc5                	j	ffffffffc0205ab0 <do_execve+0x34e>
            ret = -E_INVAL_ELF;
ffffffffc0205bc2:	5961                	li	s2,-8
ffffffffc0205bc4:	b5c5                	j	ffffffffc0205aa4 <do_execve+0x342>
ffffffffc0205bc6:	00001617          	auipc	a2,0x1
ffffffffc0205bca:	7ba60613          	addi	a2,a2,1978 # ffffffffc0207380 <default_pmm_manager+0x38>
ffffffffc0205bce:	06900593          	li	a1,105
ffffffffc0205bd2:	00001517          	auipc	a0,0x1
ffffffffc0205bd6:	7d650513          	addi	a0,a0,2006 # ffffffffc02073a8 <default_pmm_manager+0x60>
ffffffffc0205bda:	8a1fa0ef          	jal	ra,ffffffffc020047a <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205bde:	00002617          	auipc	a2,0x2
ffffffffc0205be2:	84a60613          	addi	a2,a2,-1974 # ffffffffc0207428 <default_pmm_manager+0xe0>
ffffffffc0205be6:	28700593          	li	a1,647
ffffffffc0205bea:	00003517          	auipc	a0,0x3
ffffffffc0205bee:	85650513          	addi	a0,a0,-1962 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205bf2:	889fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bf6:	00003697          	auipc	a3,0x3
ffffffffc0205bfa:	b5268693          	addi	a3,a3,-1198 # ffffffffc0208748 <default_pmm_manager+0x1400>
ffffffffc0205bfe:	00001617          	auipc	a2,0x1
ffffffffc0205c02:	0b260613          	addi	a2,a2,178 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205c06:	28200593          	li	a1,642
ffffffffc0205c0a:	00003517          	auipc	a0,0x3
ffffffffc0205c0e:	83650513          	addi	a0,a0,-1994 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205c12:	869fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205c16:	00003697          	auipc	a3,0x3
ffffffffc0205c1a:	aea68693          	addi	a3,a3,-1302 # ffffffffc0208700 <default_pmm_manager+0x13b8>
ffffffffc0205c1e:	00001617          	auipc	a2,0x1
ffffffffc0205c22:	09260613          	addi	a2,a2,146 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205c26:	28100593          	li	a1,641
ffffffffc0205c2a:	00003517          	auipc	a0,0x3
ffffffffc0205c2e:	81650513          	addi	a0,a0,-2026 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205c32:	849fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205c36:	00003697          	auipc	a3,0x3
ffffffffc0205c3a:	a8268693          	addi	a3,a3,-1406 # ffffffffc02086b8 <default_pmm_manager+0x1370>
ffffffffc0205c3e:	00001617          	auipc	a2,0x1
ffffffffc0205c42:	07260613          	addi	a2,a2,114 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205c46:	28000593          	li	a1,640
ffffffffc0205c4a:	00002517          	auipc	a0,0x2
ffffffffc0205c4e:	7f650513          	addi	a0,a0,2038 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205c52:	829fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205c56:	00003697          	auipc	a3,0x3
ffffffffc0205c5a:	a1a68693          	addi	a3,a3,-1510 # ffffffffc0208670 <default_pmm_manager+0x1328>
ffffffffc0205c5e:	00001617          	auipc	a2,0x1
ffffffffc0205c62:	05260613          	addi	a2,a2,82 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205c66:	27f00593          	li	a1,639
ffffffffc0205c6a:	00002517          	auipc	a0,0x2
ffffffffc0205c6e:	7d650513          	addi	a0,a0,2006 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205c72:	809fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205c76 <do_yield>:
    current->need_resched = 1;
ffffffffc0205c76:	000ad797          	auipc	a5,0xad
ffffffffc0205c7a:	c527b783          	ld	a5,-942(a5) # ffffffffc02b28c8 <current>
ffffffffc0205c7e:	4705                	li	a4,1
ffffffffc0205c80:	ef98                	sd	a4,24(a5)
}
ffffffffc0205c82:	4501                	li	a0,0
ffffffffc0205c84:	8082                	ret

ffffffffc0205c86 <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205c86:	1101                	addi	sp,sp,-32
ffffffffc0205c88:	e822                	sd	s0,16(sp)
ffffffffc0205c8a:	e426                	sd	s1,8(sp)
ffffffffc0205c8c:	ec06                	sd	ra,24(sp)
ffffffffc0205c8e:	842e                	mv	s0,a1
ffffffffc0205c90:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205c92:	c999                	beqz	a1,ffffffffc0205ca8 <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0205c94:	000ad797          	auipc	a5,0xad
ffffffffc0205c98:	c347b783          	ld	a5,-972(a5) # ffffffffc02b28c8 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205c9c:	7788                	ld	a0,40(a5)
ffffffffc0205c9e:	4685                	li	a3,1
ffffffffc0205ca0:	4611                	li	a2,4
ffffffffc0205ca2:	e7ffe0ef          	jal	ra,ffffffffc0204b20 <user_mem_check>
ffffffffc0205ca6:	c909                	beqz	a0,ffffffffc0205cb8 <do_wait+0x32>
ffffffffc0205ca8:	85a2                	mv	a1,s0
}
ffffffffc0205caa:	6442                	ld	s0,16(sp)
ffffffffc0205cac:	60e2                	ld	ra,24(sp)
ffffffffc0205cae:	8526                	mv	a0,s1
ffffffffc0205cb0:	64a2                	ld	s1,8(sp)
ffffffffc0205cb2:	6105                	addi	sp,sp,32
ffffffffc0205cb4:	fb8ff06f          	j	ffffffffc020546c <do_wait.part.0>
ffffffffc0205cb8:	60e2                	ld	ra,24(sp)
ffffffffc0205cba:	6442                	ld	s0,16(sp)
ffffffffc0205cbc:	64a2                	ld	s1,8(sp)
ffffffffc0205cbe:	5575                	li	a0,-3
ffffffffc0205cc0:	6105                	addi	sp,sp,32
ffffffffc0205cc2:	8082                	ret

ffffffffc0205cc4 <do_kill>:
do_kill(int pid) {
ffffffffc0205cc4:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205cc6:	6789                	lui	a5,0x2
do_kill(int pid) {
ffffffffc0205cc8:	e406                	sd	ra,8(sp)
ffffffffc0205cca:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205ccc:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205cd0:	17f9                	addi	a5,a5,-2
ffffffffc0205cd2:	02e7e963          	bltu	a5,a4,ffffffffc0205d04 <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205cd6:	842a                	mv	s0,a0
ffffffffc0205cd8:	45a9                	li	a1,10
ffffffffc0205cda:	2501                	sext.w	a0,a0
ffffffffc0205cdc:	46c000ef          	jal	ra,ffffffffc0206148 <hash32>
ffffffffc0205ce0:	02051793          	slli	a5,a0,0x20
ffffffffc0205ce4:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205ce8:	000a9797          	auipc	a5,0xa9
ffffffffc0205cec:	b5878793          	addi	a5,a5,-1192 # ffffffffc02ae840 <hash_list>
ffffffffc0205cf0:	953e                	add	a0,a0,a5
ffffffffc0205cf2:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205cf4:	a029                	j	ffffffffc0205cfe <do_kill+0x3a>
            if (proc->pid == pid) {
ffffffffc0205cf6:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0205cfa:	00870b63          	beq	a4,s0,ffffffffc0205d10 <do_kill+0x4c>
ffffffffc0205cfe:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205d00:	fef51be3          	bne	a0,a5,ffffffffc0205cf6 <do_kill+0x32>
    return -E_INVAL;
ffffffffc0205d04:	5475                	li	s0,-3
}
ffffffffc0205d06:	60a2                	ld	ra,8(sp)
ffffffffc0205d08:	8522                	mv	a0,s0
ffffffffc0205d0a:	6402                	ld	s0,0(sp)
ffffffffc0205d0c:	0141                	addi	sp,sp,16
ffffffffc0205d0e:	8082                	ret
        if (!(proc->flags & PF_EXITING)) {
ffffffffc0205d10:	fd87a703          	lw	a4,-40(a5)
ffffffffc0205d14:	00177693          	andi	a3,a4,1
ffffffffc0205d18:	e295                	bnez	a3,ffffffffc0205d3c <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205d1a:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0205d1c:	00176713          	ori	a4,a4,1
ffffffffc0205d20:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0205d24:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205d26:	fe06d0e3          	bgez	a3,ffffffffc0205d06 <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0205d2a:	f2878513          	addi	a0,a5,-216
ffffffffc0205d2e:	22e000ef          	jal	ra,ffffffffc0205f5c <wakeup_proc>
}
ffffffffc0205d32:	60a2                	ld	ra,8(sp)
ffffffffc0205d34:	8522                	mv	a0,s0
ffffffffc0205d36:	6402                	ld	s0,0(sp)
ffffffffc0205d38:	0141                	addi	sp,sp,16
ffffffffc0205d3a:	8082                	ret
        return -E_KILLED;
ffffffffc0205d3c:	545d                	li	s0,-9
ffffffffc0205d3e:	b7e1                	j	ffffffffc0205d06 <do_kill+0x42>

ffffffffc0205d40 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0205d40:	1101                	addi	sp,sp,-32
ffffffffc0205d42:	e426                	sd	s1,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0205d44:	000ad797          	auipc	a5,0xad
ffffffffc0205d48:	afc78793          	addi	a5,a5,-1284 # ffffffffc02b2840 <proc_list>
ffffffffc0205d4c:	ec06                	sd	ra,24(sp)
ffffffffc0205d4e:	e822                	sd	s0,16(sp)
ffffffffc0205d50:	e04a                	sd	s2,0(sp)
ffffffffc0205d52:	000a9497          	auipc	s1,0xa9
ffffffffc0205d56:	aee48493          	addi	s1,s1,-1298 # ffffffffc02ae840 <hash_list>
ffffffffc0205d5a:	e79c                	sd	a5,8(a5)
ffffffffc0205d5c:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205d5e:	000ad717          	auipc	a4,0xad
ffffffffc0205d62:	ae270713          	addi	a4,a4,-1310 # ffffffffc02b2840 <proc_list>
ffffffffc0205d66:	87a6                	mv	a5,s1
ffffffffc0205d68:	e79c                	sd	a5,8(a5)
ffffffffc0205d6a:	e39c                	sd	a5,0(a5)
ffffffffc0205d6c:	07c1                	addi	a5,a5,16
ffffffffc0205d6e:	fef71de3          	bne	a4,a5,ffffffffc0205d68 <proc_init+0x28>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205d72:	f9ffe0ef          	jal	ra,ffffffffc0204d10 <alloc_proc>
ffffffffc0205d76:	000ad917          	auipc	s2,0xad
ffffffffc0205d7a:	b5a90913          	addi	s2,s2,-1190 # ffffffffc02b28d0 <idleproc>
ffffffffc0205d7e:	00a93023          	sd	a0,0(s2)
ffffffffc0205d82:	0e050f63          	beqz	a0,ffffffffc0205e80 <proc_init+0x140>
...
ffffffffc0205d88:	e11c                	sd	a5,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d8a:	00003797          	auipc	a5,0x3
ffffffffc0205d8e:	27678793          	addi	a5,a5,630 # ffffffffc0209000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d92:	0b450413          	addi	s0,a0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d96:	e91c                	sd	a5,16(a0)
    idleproc->need_resched = 1;
ffffffffc0205d98:	4785                	li	a5,1
ffffffffc0205d9a:	ed1c                	sd	a5,24(a0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d9c:	4641                	li	a2,16
ffffffffc0205d9e:	4581                	li	a1,0
ffffffffc0205da0:	8522                	mv	a0,s0
ffffffffc0205da2:	027000ef          	jal	ra,ffffffffc02065c8 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205da6:	463d                	li	a2,15
ffffffffc0205da8:	00003597          	auipc	a1,0x3
ffffffffc0205dac:	a0058593          	addi	a1,a1,-1536 # ffffffffc02087a8 <default_pmm_manager+0x1460>
ffffffffc0205db0:	8522                	mv	a0,s0
ffffffffc0205db2:	029000ef          	jal	ra,ffffffffc02065da <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0205db6:	000ad717          	auipc	a4,0xad
ffffffffc0205dba:	b2a70713          	addi	a4,a4,-1238 # ffffffffc02b28e0 <nr_process>
ffffffffc0205dbe:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0205dc0:	00093683          	ld	a3,0(s2)
...
ffffffffc0205dce:	87450513          	addi	a0,a0,-1932 # ffffffffc020563e <init_main>
    nr_process ++;
ffffffffc0205dd2:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0205dd4:	000ad797          	auipc	a5,0xad
ffffffffc0205dd8:	aed7ba23          	sd	a3,-1292(a5) # ffffffffc02b28c8 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205ddc:	cf6ff0ef          	jal	ra,ffffffffc02052d2 <kernel_thread>
ffffffffc0205de0:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0205de2:	08a05363          	blez	a0,ffffffffc0205e68 <proc_init+0x128>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205de6:	6789                	lui	a5,0x2
ffffffffc0205de8:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205dec:	17f9                	addi	a5,a5,-2
ffffffffc0205dee:	2501                	sext.w	a0,a0
ffffffffc0205df0:	02e7e363          	bltu	a5,a4,ffffffffc0205e16 <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205df4:	45a9                	li	a1,10
ffffffffc0205df6:	352000ef          	jal	ra,ffffffffc0206148 <hash32>
ffffffffc0205dfa:	02051793          	slli	a5,a0,0x20
ffffffffc0205dfe:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0205e02:	96a6                	add	a3,a3,s1
ffffffffc0205e04:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0205e06:	a029                	j	ffffffffc0205e10 <proc_init+0xd0>
            if (proc->pid == pid) {
ffffffffc0205e08:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7c8c>
ffffffffc0205e0c:	04870b63          	beq	a4,s0,ffffffffc0205e62 <proc_init+0x122>
    return listelm->next;
ffffffffc0205e10:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205e12:	fef69be3          	bne	a3,a5,ffffffffc0205e08 <proc_init+0xc8>
    return NULL;
ffffffffc0205e16:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205e18:	0b478493          	addi	s1,a5,180
ffffffffc0205e1c:	4641                	li	a2,16
ffffffffc0205e1e:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205e20:	000ad417          	auipc	s0,0xad
ffffffffc0205e24:	ab840413          	addi	s0,s0,-1352 # ffffffffc02b28d8 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205e28:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0205e2a:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205e2c:	79c000ef          	jal	ra,ffffffffc02065c8 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205e30:	463d                	li	a2,15
ffffffffc0205e32:	00003597          	auipc	a1,0x3
ffffffffc0205e36:	99e58593          	addi	a1,a1,-1634 # ffffffffc02087d0 <default_pmm_manager+0x1488>
ffffffffc0205e3a:	8526                	mv	a0,s1
ffffffffc0205e3c:	79e000ef          	jal	ra,ffffffffc02065da <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e40:	00093783          	ld	a5,0(s2)
ffffffffc0205e44:	cbb5                	beqz	a5,ffffffffc0205eb8 <proc_init+0x178>
ffffffffc0205e46:	43dc                	lw	a5,4(a5)
ffffffffc0205e48:	eba5                	bnez	a5,ffffffffc0205eb8 <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e4a:	601c                	ld	a5,0(s0)
ffffffffc0205e4c:	c7b1                	beqz	a5,ffffffffc0205e98 <proc_init+0x158>
ffffffffc0205e4e:	43d8                	lw	a4,4(a5)
ffffffffc0205e50:	4785                	li	a5,1
ffffffffc0205e52:	04f71363          	bne	a4,a5,ffffffffc0205e98 <proc_init+0x158>
}
ffffffffc0205e56:	60e2                	ld	ra,24(sp)
ffffffffc0205e58:	6442                	ld	s0,16(sp)
ffffffffc0205e5a:	64a2                	ld	s1,8(sp)
ffffffffc0205e5c:	6902                	ld	s2,0(sp)
ffffffffc0205e5e:	6105                	addi	sp,sp,32
ffffffffc0205e60:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205e62:	f2878793          	addi	a5,a5,-216
ffffffffc0205e66:	bf4d                	j	ffffffffc0205e18 <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc0205e68:	00003617          	auipc	a2,0x3
ffffffffc0205e6c:	94860613          	addi	a2,a2,-1720 # ffffffffc02087b0 <default_pmm_manager+0x1468>
ffffffffc0205e70:	38f00593          	li	a1,911
ffffffffc0205e74:	00002517          	auipc	a0,0x2
ffffffffc0205e78:	5cc50513          	addi	a0,a0,1484 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205e7c:	dfefa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0205e80:	00003617          	auipc	a2,0x3
ffffffffc0205e84:	91060613          	addi	a2,a2,-1776 # ffffffffc0208790 <default_pmm_manager+0x1448>
ffffffffc0205e88:	38100593          	li	a1,897
ffffffffc0205e8c:	00002517          	auipc	a0,0x2
ffffffffc0205e90:	5b450513          	addi	a0,a0,1460 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205e94:	de6fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e98:	00003697          	auipc	a3,0x3
ffffffffc0205e9c:	96868693          	addi	a3,a3,-1688 # ffffffffc0208800 <default_pmm_manager+0x14b8>
ffffffffc0205ea0:	00001617          	auipc	a2,0x1
ffffffffc0205ea4:	e1060613          	addi	a2,a2,-496 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205ea8:	39600593          	li	a1,918
ffffffffc0205eac:	00002517          	auipc	a0,0x2
ffffffffc0205eb0:	59450513          	addi	a0,a0,1428 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205eb4:	dc6fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205eb8:	00003697          	auipc	a3,0x3
ffffffffc0205ebc:	92068693          	addi	a3,a3,-1760 # ffffffffc02087d8 <default_pmm_manager+0x1490>
ffffffffc0205ec0:	00001617          	auipc	a2,0x1
ffffffffc0205ec4:	df060613          	addi	a2,a2,-528 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205ec8:	39500593          	li	a1,917
ffffffffc0205ecc:	00002517          	auipc	a0,0x2
ffffffffc0205ed0:	57450513          	addi	a0,a0,1396 # ffffffffc0208440 <default_pmm_manager+0x10f8>
ffffffffc0205ed4:	da6fa0ef          	jal	ra,ffffffffc020047a <__panic>
...
ffffffffc0205ede:	000ad417          	auipc	s0,0xad
ffffffffc0205ee2:	9ea40413          	addi	s0,s0,-1558 # ffffffffc02b28c8 <current>
    while (1) {
        if (current->need_resched) {
...
ffffffffc0205eea:	dffd                	beqz	a5,ffffffffc0205ee8 <cpu_idle+0x10>
            schedule();
ffffffffc0205eec:	0f0000ef          	jal	ra,ffffffffc0205fdc <schedule>
...
ffffffffc0205f64:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f66:	478d                	li	a5,3
ffffffffc0205f68:	04f70b63          	beq	a4,a5,ffffffffc0205fbe <wakeup_proc+0x62>
ffffffffc0205f6c:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f6e:	100027f3          	csrr	a5,sstatus
ffffffffc0205f72:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205f74:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f76:	ef9d                	bnez	a5,ffffffffc0205fb4 <wakeup_proc+0x58>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f78:	4789                	li	a5,2
ffffffffc0205f7a:	02f70163          	beq	a4,a5,ffffffffc0205f9c <wakeup_proc+0x40>
            proc->state = PROC_RUNNABLE;
ffffffffc0205f7e:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc0205f80:	0e042623          	sw	zero,236(s0)
    if (flag) {
ffffffffc0205f84:	e491                	bnez	s1,ffffffffc0205f90 <wakeup_proc+0x34>
        else {
...
ffffffffc0205f94:	64a2                	ld	s1,8(sp)
ffffffffc0205f96:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205f98:	ea8fa06f          	j	ffffffffc0200640 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205f9c:	00003617          	auipc	a2,0x3
ffffffffc0205fa0:	8c460613          	addi	a2,a2,-1852 # ffffffffc0208860 <default_pmm_manager+0x1518>
ffffffffc0205fa4:	45c9                	li	a1,18
ffffffffc0205fa6:	00003517          	auipc	a0,0x3
ffffffffc0205faa:	8a250513          	addi	a0,a0,-1886 # ffffffffc0208848 <default_pmm_manager+0x1500>
ffffffffc0205fae:	d34fa0ef          	jal	ra,ffffffffc02004e2 <__warn>
ffffffffc0205fb2:	bfc9                	j	ffffffffc0205f84 <wakeup_proc+0x28>
        intr_disable();
ffffffffc0205fb4:	e92fa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205fb8:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc0205fba:	4485                	li	s1,1
ffffffffc0205fbc:	bf75                	j	ffffffffc0205f78 <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205fbe:	00003697          	auipc	a3,0x3
ffffffffc0205fc2:	86a68693          	addi	a3,a3,-1942 # ffffffffc0208828 <default_pmm_manager+0x14e0>
ffffffffc0205fc6:	00001617          	auipc	a2,0x1
ffffffffc0205fca:	cea60613          	addi	a2,a2,-790 # ffffffffc0206cb0 <commands+0x450>
ffffffffc0205fce:	45a5                	li	a1,9
ffffffffc0205fd0:	00003517          	auipc	a0,0x3
ffffffffc0205fd4:	87850513          	addi	a0,a0,-1928 # ffffffffc0208848 <default_pmm_manager+0x1500>
...
ffffffffc0205fea:	efbd                	bnez	a5,ffffffffc0206068 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0205fec:	000ad897          	auipc	a7,0xad
ffffffffc0205ff0:	8dc8b883          	ld	a7,-1828(a7) # ffffffffc02b28c8 <current>
ffffffffc0205ff4:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205ff8:	000ad517          	auipc	a0,0xad
ffffffffc0205ffc:	8d853503          	ld	a0,-1832(a0) # ffffffffc02b28d0 <idleproc>
ffffffffc0206000:	04a88e63          	beq	a7,a0,ffffffffc020605c <schedule+0x80>
ffffffffc0206004:	0c888693          	addi	a3,a7,200
ffffffffc0206008:	000ad617          	auipc	a2,0xad
ffffffffc020600c:	83860613          	addi	a2,a2,-1992 # ffffffffc02b2840 <proc_list>
        le = last;
ffffffffc0206010:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc0206012:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc0206014:	4809                	li	a6,2
ffffffffc0206016:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0206018:	00c78863          	beq	a5,a2,ffffffffc0206028 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc020601c:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0206020:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0206024:	03070163          	beq	a4,a6,ffffffffc0206046 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0206028:	fef697e3          	bne	a3,a5,ffffffffc0206016 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc020602c:	ed89                	bnez	a1,ffffffffc0206046 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc020602e:	451c                	lw	a5,8(a0)
ffffffffc0206030:	2785                	addiw	a5,a5,1
ffffffffc0206032:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0206034:	00a88463          	beq	a7,a0,ffffffffc020603c <schedule+0x60>
            proc_run(next);
ffffffffc0206038:	e4dfe0ef          	jal	ra,ffffffffc0204e84 <proc_run>
    if (flag) {
ffffffffc020603c:	e819                	bnez	s0,ffffffffc0206052 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc0206044:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0206046:	4198                	lw	a4,0(a1)
ffffffffc0206048:	4789                	li	a5,2
ffffffffc020604a:	fef712e3          	bne	a4,a5,ffffffffc020602e <schedule+0x52>
ffffffffc020604e:	852e                	mv	a0,a1
ffffffffc0206050:	bff9                	j	ffffffffc020602e <schedule+0x52>
}
ffffffffc0206052:	6402                	ld	s0,0(sp)
ffffffffc0206054:	60a2                	ld	ra,8(sp)
ffffffffc0206056:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0206058:	de8fa06f          	j	ffffffffc0200640 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020605c:	000ac617          	auipc	a2,0xac
ffffffffc0206060:	7e460613          	addi	a2,a2,2020 # ffffffffc02b2840 <proc_list>
ffffffffc0206064:	86b2                	mv	a3,a2
ffffffffc0206066:	b76d                	j	ffffffffc0206010 <schedule+0x34>
        intr_disable();
ffffffffc0206068:	ddefa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc020606c:	4405                	li	s0,1
ffffffffc020606e:	bfbd                	j	ffffffffc0205fec <schedule+0x10>

ffffffffc0206070 <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc0206070:	000ad797          	auipc	a5,0xad
ffffffffc0206074:	8587b783          	ld	a5,-1960(a5) # ffffffffc02b28c8 <current>
}
ffffffffc0206078:	43c8                	lw	a0,4(a5)
ffffffffc020607a:	8082                	ret

ffffffffc020607c <sys_pgdir>:
...
ffffffffc0206080 <sys_putc>:
    cputchar(c);
ffffffffc0206080:	4108                	lw	a0,0(a0)
sys_putc(uint64_t arg[]) {
ffffffffc0206082:	1141                	addi	sp,sp,-16
ffffffffc0206084:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc0206086:	930fa0ef          	jal	ra,ffffffffc02001b6 <cputchar>
}
ffffffffc020608a:	60a2                	ld	ra,8(sp)
ffffffffc020608c:	4501                	li	a0,0
ffffffffc020608e:	0141                	addi	sp,sp,16
ffffffffc0206090:	8082                	ret

ffffffffc0206092 <sys_kill>:
    return do_kill(pid);
ffffffffc0206092:	4108                	lw	a0,0(a0)
ffffffffc0206094:	c31ff06f          	j	ffffffffc0205cc4 <do_kill>

ffffffffc0206098 <sys_yield>:
    return do_yield();
ffffffffc0206098:	bdfff06f          	j	ffffffffc0205c76 <do_yield>

ffffffffc020609c <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc020609c:	6d14                	ld	a3,24(a0)
ffffffffc020609e:	6910                	ld	a2,16(a0)
ffffffffc02060a0:	650c                	ld	a1,8(a0)
ffffffffc02060a2:	6108                	ld	a0,0(a0)
ffffffffc02060a4:	ebeff06f          	j	ffffffffc0205762 <do_execve>

ffffffffc02060a8 <sys_wait>:
    return do_wait(pid, store);
ffffffffc02060a8:	650c                	ld	a1,8(a0)
ffffffffc02060aa:	4108                	lw	a0,0(a0)
ffffffffc02060ac:	bdbff06f          	j	ffffffffc0205c86 <do_wait>

ffffffffc02060b0 <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc02060b0:	000ad797          	auipc	a5,0xad
ffffffffc02060b4:	8187b783          	ld	a5,-2024(a5) # ffffffffc02b28c8 <current>
ffffffffc02060b8:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc02060ba:	4501                	li	a0,0
ffffffffc02060bc:	6a0c                	ld	a1,16(a2)
ffffffffc02060be:	e33fe06f          	j	ffffffffc0204ef0 <do_fork>

ffffffffc02060c2 <sys_exit>:
    return do_exit(error_code);
ffffffffc02060c2:	4108                	lw	a0,0(a0)
ffffffffc02060c4:	a5eff06f          	j	ffffffffc0205322 <do_exit>

ffffffffc02060c8 <syscall>:
};
...
void
syscall(void) {
ffffffffc02060c8:	715d                	addi	sp,sp,-80
ffffffffc02060ca:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc02060cc:	000ac497          	auipc	s1,0xac
ffffffffc02060d0:	7fc48493          	addi	s1,s1,2044 # ffffffffc02b28c8 <current>
ffffffffc02060d4:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc02060d6:	e0a2                	sd	s0,64(sp)
ffffffffc02060d8:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc02060da:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc02060dc:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02060de:	47fd                	li	a5,31
    int num = tf->gpr.a0;
ffffffffc02060e0:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02060e4:	0327ee63          	bltu	a5,s2,ffffffffc0206120 <syscall+0x58>
        if (syscalls[num] != NULL) {
ffffffffc02060e8:	00391713          	slli	a4,s2,0x3
ffffffffc02060ec:	00002797          	auipc	a5,0x2
ffffffffc02060f0:	7dc78793          	addi	a5,a5,2012 # ffffffffc02088c8 <syscalls>
ffffffffc02060f4:	97ba                	add	a5,a5,a4
ffffffffc02060f6:	639c                	ld	a5,0(a5)
ffffffffc02060f8:	c785                	beqz	a5,ffffffffc0206120 <syscall+0x58>
            arg[0] = tf->gpr.a1;
ffffffffc02060fa:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc02060fc:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc02060fe:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc0206100:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc0206102:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc0206104:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc0206106:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc0206108:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc020610a:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc020610c:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc020610e:	0028                	addi	a0,sp,8
ffffffffc0206110:	9782                	jalr	a5
        }
    }
    print_trapframe(tf);
...
ffffffffc0206112:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc0206114:	e828                	sd	a0,80(s0)
}
ffffffffc0206116:	6406                	ld	s0,64(sp)
ffffffffc0206118:	74e2                	ld	s1,56(sp)
ffffffffc020611a:	7942                	ld	s2,48(sp)
ffffffffc020611c:	6161                	addi	sp,sp,80
ffffffffc020611e:	8082                	ret
    print_trapframe(tf);
ffffffffc0206120:	8522                	mv	a0,s0
ffffffffc0206122:	f12fa0ef          	jal	ra,ffffffffc0200834 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc0206126:	609c                	ld	a5,0(s1)
ffffffffc0206128:	86ca                	mv	a3,s2
ffffffffc020612a:	00002617          	auipc	a2,0x2
ffffffffc020612e:	75660613          	addi	a2,a2,1878 # ffffffffc0208880 <default_pmm_manager+0x1538>
ffffffffc0206132:	43d8                	lw	a4,4(a5)
ffffffffc0206134:	06200593          	li	a1,98
ffffffffc0206138:	0b478793          	addi	a5,a5,180
ffffffffc020613c:	00002517          	auipc	a0,0x2
ffffffffc0206140:	77450513          	addi	a0,a0,1908 # ffffffffc02088b0 <default_pmm_manager+0x1568>
ffffffffc0206144:	b36fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0206148 <hash32>:
 *
...
ffffffffc0206148:	9e3707b7          	lui	a5,0x9e370
ffffffffc020614c:	2785                	addiw	a5,a5,1
ffffffffc020614e:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0206152:	02000793          	li	a5,32
ffffffffc0206156:	9f8d                	subw	a5,a5,a1
}
ffffffffc0206158:	00f5553b          	srlw	a0,a0,a5
ffffffffc020615c:	8082                	ret

ffffffffc020615e <printnum>:
 * */
static void
...
ffffffffc020615e:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206162:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0206164:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206168:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc020616a:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020616e:	f022                	sd	s0,32(sp)
ffffffffc0206170:	ec26                	sd	s1,24(sp)
ffffffffc0206172:	e84a                	sd	s2,16(sp)
ffffffffc0206174:	f406                	sd	ra,40(sp)
ffffffffc0206176:	e44e                	sd	s3,8(sp)
ffffffffc0206178:	84aa                	mv	s1,a0
ffffffffc020617a:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc020617c:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0206180:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0206182:	03067e63          	bgeu	a2,a6,ffffffffc02061be <printnum+0x60>
ffffffffc0206186:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0206188:	00805763          	blez	s0,ffffffffc0206196 <printnum+0x38>
ffffffffc020618c:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc020618e:	85ca                	mv	a1,s2
ffffffffc0206190:	854e                	mv	a0,s3
ffffffffc0206192:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0206194:	fc65                	bnez	s0,ffffffffc020618c <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206196:	1a02                	slli	s4,s4,0x20
ffffffffc0206198:	00003797          	auipc	a5,0x3
ffffffffc020619c:	83078793          	addi	a5,a5,-2000 # ffffffffc02089c8 <syscalls+0x100>
ffffffffc02061a0:	020a5a13          	srli	s4,s4,0x20
ffffffffc02061a4:	9a3e                	add	s4,s4,a5
...
ffffffffc02061a6:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02061a8:	000a4503          	lbu	a0,0(s4)
}
ffffffffc02061ac:	70a2                	ld	ra,40(sp)
ffffffffc02061ae:	69a2                	ld	s3,8(sp)
ffffffffc02061b0:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02061b2:	85ca                	mv	a1,s2
ffffffffc02061b4:	87a6                	mv	a5,s1
}
ffffffffc02061b6:	6942                	ld	s2,16(sp)
ffffffffc02061b8:	64e2                	ld	s1,24(sp)
ffffffffc02061ba:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02061bc:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc02061be:	03065633          	divu	a2,a2,a6
ffffffffc02061c2:	8722                	mv	a4,s0
ffffffffc02061c4:	f9bff0ef          	jal	ra,ffffffffc020615e <printnum>
ffffffffc02061c8:	b7f9                	j	ffffffffc0206196 <printnum+0x38>

ffffffffc02061ca <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc02061ca:	7119                	addi	sp,sp,-128
ffffffffc02061cc:	f4a6                	sd	s1,104(sp)
ffffffffc02061ce:	f0ca                	sd	s2,96(sp)
ffffffffc02061d0:	ecce                	sd	s3,88(sp)
ffffffffc02061d2:	e8d2                	sd	s4,80(sp)
ffffffffc02061d4:	e4d6                	sd	s5,72(sp)
ffffffffc02061d6:	e0da                	sd	s6,64(sp)
ffffffffc02061d8:	fc5e                	sd	s7,56(sp)
ffffffffc02061da:	f06a                	sd	s10,32(sp)
ffffffffc02061dc:	fc86                	sd	ra,120(sp)
ffffffffc02061de:	f8a2                	sd	s0,112(sp)
ffffffffc02061e0:	f862                	sd	s8,48(sp)
ffffffffc02061e2:	f466                	sd	s9,40(sp)
ffffffffc02061e4:	ec6e                	sd	s11,24(sp)
ffffffffc02061e6:	892a                	mv	s2,a0
ffffffffc02061e8:	84ae                	mv	s1,a1
ffffffffc02061ea:	8d32                	mv	s10,a2
ffffffffc02061ec:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc02061ee:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02061f2:	5b7d                	li	s6,-1
ffffffffc02061f4:	00003a97          	auipc	s5,0x3
ffffffffc02061f8:	800a8a93          	addi	s5,s5,-2048 # ffffffffc02089f4 <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02061fc:	00003b97          	auipc	s7,0x3
ffffffffc0206200:	a14b8b93          	addi	s7,s7,-1516 # ffffffffc0208c10 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0206204:	000d4503          	lbu	a0,0(s10)
ffffffffc0206208:	001d0413          	addi	s0,s10,1
ffffffffc020620c:	01350a63          	beq	a0,s3,ffffffffc0206220 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0206210:	c121                	beqz	a0,ffffffffc0206250 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0206212:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0206214:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0206216:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0206218:	fff44503          	lbu	a0,-1(s0)
ffffffffc020621c:	ff351ae3          	bne	a0,s3,ffffffffc0206210 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206220:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0206224:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0206228:	4c81                	li	s9,0
ffffffffc020622a:	4881                	li	a7,0
        width = precision = -1;
ffffffffc020622c:	5c7d                	li	s8,-1
ffffffffc020622e:	5dfd                	li	s11,-1
ffffffffc0206230:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0206234:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206236:	fdd6059b          	addiw	a1,a2,-35
ffffffffc020623a:	0ff5f593          	zext.b	a1,a1
ffffffffc020623e:	00140d13          	addi	s10,s0,1
ffffffffc0206242:	04b56263          	bltu	a0,a1,ffffffffc0206286 <vprintfmt+0xbc>
ffffffffc0206246:	058a                	slli	a1,a1,0x2
ffffffffc0206248:	95d6                	add	a1,a1,s5
ffffffffc020624a:	4194                	lw	a3,0(a1)
ffffffffc020624c:	96d6                	add	a3,a3,s5
ffffffffc020624e:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0206250:	70e6                	ld	ra,120(sp)
ffffffffc0206252:	7446                	ld	s0,112(sp)
ffffffffc0206254:	74a6                	ld	s1,104(sp)
ffffffffc0206256:	7906                	ld	s2,96(sp)
ffffffffc0206258:	69e6                	ld	s3,88(sp)
ffffffffc020625a:	6a46                	ld	s4,80(sp)
ffffffffc020625c:	6aa6                	ld	s5,72(sp)
ffffffffc020625e:	6b06                	ld	s6,64(sp)
ffffffffc0206260:	7be2                	ld	s7,56(sp)
ffffffffc0206262:	7c42                	ld	s8,48(sp)
ffffffffc0206264:	7ca2                	ld	s9,40(sp)
ffffffffc0206266:	7d02                	ld	s10,32(sp)
ffffffffc0206268:	6de2                	ld	s11,24(sp)
ffffffffc020626a:	6109                	addi	sp,sp,128
ffffffffc020626c:	8082                	ret
            padc = '0';
ffffffffc020626e:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0206270:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206274:	846a                	mv	s0,s10
ffffffffc0206276:	00140d13          	addi	s10,s0,1
ffffffffc020627a:	fdd6059b          	addiw	a1,a2,-35
ffffffffc020627e:	0ff5f593          	zext.b	a1,a1
ffffffffc0206282:	fcb572e3          	bgeu	a0,a1,ffffffffc0206246 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0206286:	85a6                	mv	a1,s1
ffffffffc0206288:	02500513          	li	a0,37
ffffffffc020628c:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc020628e:	fff44783          	lbu	a5,-1(s0)
ffffffffc0206292:	8d22                	mv	s10,s0
ffffffffc0206294:	f73788e3          	beq	a5,s3,ffffffffc0206204 <vprintfmt+0x3a>
ffffffffc0206298:	ffed4783          	lbu	a5,-2(s10)
ffffffffc020629c:	1d7d                	addi	s10,s10,-1
ffffffffc020629e:	ff379de3          	bne	a5,s3,ffffffffc0206298 <vprintfmt+0xce>
ffffffffc02062a2:	b78d                	j	ffffffffc0206204 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc02062a4:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc02062a8:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062ac:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc02062ae:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc02062b2:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02062b6:	02d86463          	bltu	a6,a3,ffffffffc02062de <vprintfmt+0x114>
                ch = *fmt;
ffffffffc02062ba:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc02062be:	002c169b          	slliw	a3,s8,0x2
ffffffffc02062c2:	0186873b          	addw	a4,a3,s8
ffffffffc02062c6:	0017171b          	slliw	a4,a4,0x1
ffffffffc02062ca:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc02062cc:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc02062d0:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc02062d2:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc02062d6:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02062da:	fed870e3          	bgeu	a6,a3,ffffffffc02062ba <vprintfmt+0xf0>
            if (width < 0)
ffffffffc02062de:	f40ddce3          	bgez	s11,ffffffffc0206236 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02062e2:	8de2                	mv	s11,s8
ffffffffc02062e4:	5c7d                	li	s8,-1
ffffffffc02062e6:	bf81                	j	ffffffffc0206236 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02062e8:	fffdc693          	not	a3,s11
ffffffffc02062ec:	96fd                	srai	a3,a3,0x3f
ffffffffc02062ee:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062f2:	00144603          	lbu	a2,1(s0)
ffffffffc02062f6:	2d81                	sext.w	s11,s11
ffffffffc02062f8:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02062fa:	bf35                	j	ffffffffc0206236 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02062fc:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206300:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0206304:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206306:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0206308:	bfd9                	j	ffffffffc02062de <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc020630a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020630c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0206310:	01174463          	blt	a4,a7,ffffffffc0206318 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0206314:	1a088e63          	beqz	a7,ffffffffc02064d0 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0206318:	000a3603          	ld	a2,0(s4)
ffffffffc020631c:	46c1                	li	a3,16
ffffffffc020631e:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0206320:	2781                	sext.w	a5,a5
ffffffffc0206322:	876e                	mv	a4,s11
ffffffffc0206324:	85a6                	mv	a1,s1
ffffffffc0206326:	854a                	mv	a0,s2
ffffffffc0206328:	e37ff0ef          	jal	ra,ffffffffc020615e <printnum>
            break;
ffffffffc020632c:	bde1                	j	ffffffffc0206204 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc020632e:	000a2503          	lw	a0,0(s4)
ffffffffc0206332:	85a6                	mv	a1,s1
ffffffffc0206334:	0a21                	addi	s4,s4,8
ffffffffc0206336:	9902                	jalr	s2
            break;
ffffffffc0206338:	b5f1                	j	ffffffffc0206204 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020633a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020633c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0206340:	01174463          	blt	a4,a7,ffffffffc0206348 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0206344:	18088163          	beqz	a7,ffffffffc02064c6 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0206348:	000a3603          	ld	a2,0(s4)
ffffffffc020634c:	46a9                	li	a3,10
ffffffffc020634e:	8a2e                	mv	s4,a1
ffffffffc0206350:	bfc1                	j	ffffffffc0206320 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206352:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0206356:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206358:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020635a:	bdf1                	j	ffffffffc0206236 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc020635c:	85a6                	mv	a1,s1
ffffffffc020635e:	02500513          	li	a0,37
ffffffffc0206362:	9902                	jalr	s2
            break;
ffffffffc0206364:	b545                	j	ffffffffc0206204 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206366:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc020636a:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020636c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020636e:	b5e1                	j	ffffffffc0206236 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0206370:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0206372:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0206376:	01174463          	blt	a4,a7,ffffffffc020637e <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc020637a:	14088163          	beqz	a7,ffffffffc02064bc <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc020637e:	000a3603          	ld	a2,0(s4)
ffffffffc0206382:	46a1                	li	a3,8
ffffffffc0206384:	8a2e                	mv	s4,a1
ffffffffc0206386:	bf69                	j	ffffffffc0206320 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0206388:	03000513          	li	a0,48
...
ffffffffc0206394:	07800513          	li	a0,120
ffffffffc0206398:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020639a:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc020639c:	6782                	ld	a5,0(sp)
ffffffffc020639e:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02063a0:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02063a4:	bfb5                	j	ffffffffc0206320 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02063a6:	000a3403          	ld	s0,0(s4)
ffffffffc02063aa:	008a0713          	addi	a4,s4,8
ffffffffc02063ae:	e03a                	sd	a4,0(sp)
ffffffffc02063b0:	14040263          	beqz	s0,ffffffffc02064f4 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02063b4:	0fb05763          	blez	s11,ffffffffc02064a2 <vprintfmt+0x2d8>
ffffffffc02063b8:	02d00693          	li	a3,45
ffffffffc02063bc:	0cd79163          	bne	a5,a3,ffffffffc020647e <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063c0:	00044783          	lbu	a5,0(s0)
ffffffffc02063c4:	0007851b          	sext.w	a0,a5
ffffffffc02063c8:	cf85                	beqz	a5,ffffffffc0206400 <vprintfmt+0x236>
ffffffffc02063ca:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02063ce:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063d2:	000c4563          	bltz	s8,ffffffffc02063dc <vprintfmt+0x212>
ffffffffc02063d6:	3c7d                	addiw	s8,s8,-1
ffffffffc02063d8:	036c0263          	beq	s8,s6,ffffffffc02063fc <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02063dc:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02063de:	0e0c8e63          	beqz	s9,ffffffffc02064da <vprintfmt+0x310>
ffffffffc02063e2:	3781                	addiw	a5,a5,-32
ffffffffc02063e4:	0ef47b63          	bgeu	s0,a5,ffffffffc02064da <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02063e8:	03f00513          	li	a0,63
ffffffffc02063ec:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063ee:	000a4783          	lbu	a5,0(s4)
ffffffffc02063f2:	3dfd                	addiw	s11,s11,-1
ffffffffc02063f4:	0a05                	addi	s4,s4,1
ffffffffc02063f6:	0007851b          	sext.w	a0,a5
ffffffffc02063fa:	ffe1                	bnez	a5,ffffffffc02063d2 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02063fc:	01b05963          	blez	s11,ffffffffc020640e <vprintfmt+0x244>
...
ffffffffc0206408:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc020640a:	fe0d9be3          	bnez	s11,ffffffffc0206400 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020640e:	6a02                	ld	s4,0(sp)
ffffffffc0206410:	bbd5                	j	ffffffffc0206204 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0206412:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0206414:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0206418:	01174463          	blt	a4,a7,ffffffffc0206420 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc020641c:	08088d63          	beqz	a7,ffffffffc02064b6 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0206420:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0206424:	0a044d63          	bltz	s0,ffffffffc02064de <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0206428:	8622                	mv	a2,s0
ffffffffc020642a:	8a66                	mv	s4,s9
ffffffffc020642c:	46a9                	li	a3,10
ffffffffc020642e:	bdcd                	j	ffffffffc0206320 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0206430:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0206434:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc0206436:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0206438:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc020643c:	8fb5                	xor	a5,a5,a3
ffffffffc020643e:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0206442:	02d74163          	blt	a4,a3,ffffffffc0206464 <vprintfmt+0x29a>
ffffffffc0206446:	00369793          	slli	a5,a3,0x3
ffffffffc020644a:	97de                	add	a5,a5,s7
ffffffffc020644c:	639c                	ld	a5,0(a5)
ffffffffc020644e:	cb99                	beqz	a5,ffffffffc0206464 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0206450:	86be                	mv	a3,a5
ffffffffc0206452:	00000617          	auipc	a2,0x0
ffffffffc0206456:	1ce60613          	addi	a2,a2,462 # ffffffffc0206620 <etext+0x2e>
ffffffffc020645a:	85a6                	mv	a1,s1
ffffffffc020645c:	854a                	mv	a0,s2
ffffffffc020645e:	0ce000ef          	jal	ra,ffffffffc020652c <printfmt>
ffffffffc0206462:	b34d                	j	ffffffffc0206204 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0206464:	00002617          	auipc	a2,0x2
ffffffffc0206468:	58460613          	addi	a2,a2,1412 # ffffffffc02089e8 <syscalls+0x120>
ffffffffc020646c:	85a6                	mv	a1,s1
ffffffffc020646e:	854a                	mv	a0,s2
ffffffffc0206470:	0bc000ef          	jal	ra,ffffffffc020652c <printfmt>
ffffffffc0206474:	bb41                	j	ffffffffc0206204 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0206476:	00002417          	auipc	s0,0x2
ffffffffc020647a:	56a40413          	addi	s0,s0,1386 # ffffffffc02089e0 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020647e:	85e2                	mv	a1,s8
ffffffffc0206480:	8522                	mv	a0,s0
ffffffffc0206482:	e43e                	sd	a5,8(sp)
ffffffffc0206484:	0e2000ef          	jal	ra,ffffffffc0206566 <strnlen>
ffffffffc0206488:	40ad8dbb          	subw	s11,s11,a0
ffffffffc020648c:	01b05b63          	blez	s11,ffffffffc02064a2 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0206490:	67a2                	ld	a5,8(sp)
ffffffffc0206492:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206496:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0206498:	85a6                	mv	a1,s1
ffffffffc020649a:	8552                	mv	a0,s4
ffffffffc020649c:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020649e:	fe0d9ce3          	bnez	s11,ffffffffc0206496 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02064a2:	00044783          	lbu	a5,0(s0)
ffffffffc02064a6:	00140a13          	addi	s4,s0,1
ffffffffc02064aa:	0007851b          	sext.w	a0,a5
ffffffffc02064ae:	d3a5                	beqz	a5,ffffffffc020640e <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02064b0:	05e00413          	li	s0,94
ffffffffc02064b4:	bf39                	j	ffffffffc02063d2 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02064b6:	000a2403          	lw	s0,0(s4)
ffffffffc02064ba:	b7ad                	j	ffffffffc0206424 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02064bc:	000a6603          	lwu	a2,0(s4)
ffffffffc02064c0:	46a1                	li	a3,8
ffffffffc02064c2:	8a2e                	mv	s4,a1
ffffffffc02064c4:	bdb1                	j	ffffffffc0206320 <vprintfmt+0x156>
ffffffffc02064c6:	000a6603          	lwu	a2,0(s4)
ffffffffc02064ca:	46a9                	li	a3,10
ffffffffc02064cc:	8a2e                	mv	s4,a1
ffffffffc02064ce:	bd89                	j	ffffffffc0206320 <vprintfmt+0x156>
ffffffffc02064d0:	000a6603          	lwu	a2,0(s4)
ffffffffc02064d4:	46c1                	li	a3,16
ffffffffc02064d6:	8a2e                	mv	s4,a1
ffffffffc02064d8:	b5a1                	j	ffffffffc0206320 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02064da:	9902                	jalr	s2
ffffffffc02064dc:	bf09                	j	ffffffffc02063ee <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02064de:	85a6                	mv	a1,s1
ffffffffc02064e0:	02d00513          	li	a0,45
ffffffffc02064e4:	e03e                	sd	a5,0(sp)
ffffffffc02064e6:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02064e8:	6782                	ld	a5,0(sp)
ffffffffc02064ea:	8a66                	mv	s4,s9
ffffffffc02064ec:	40800633          	neg	a2,s0
ffffffffc02064f0:	46a9                	li	a3,10
ffffffffc02064f2:	b53d                	j	ffffffffc0206320 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02064f4:	03b05163          	blez	s11,ffffffffc0206516 <vprintfmt+0x34c>
ffffffffc02064f8:	02d00693          	li	a3,45
ffffffffc02064fc:	f6d79de3          	bne	a5,a3,ffffffffc0206476 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0206500:	00002417          	auipc	s0,0x2
ffffffffc0206504:	4e040413          	addi	s0,s0,1248 # ffffffffc02089e0 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206508:	02800793          	li	a5,40
ffffffffc020650c:	02800513          	li	a0,40
ffffffffc0206510:	00140a13          	addi	s4,s0,1
ffffffffc0206514:	bd6d                	j	ffffffffc02063ce <vprintfmt+0x204>
ffffffffc0206516:	00002a17          	auipc	s4,0x2
ffffffffc020651a:	4cba0a13          	addi	s4,s4,1227 # ffffffffc02089e1 <syscalls+0x119>
ffffffffc020651e:	02800513          	li	a0,40
ffffffffc0206522:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206526:	05e00413          	li	s0,94
ffffffffc020652a:	b565                	j	ffffffffc02063d2 <vprintfmt+0x208>
...
ffffffffc0206540:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0206542:	c89ff0ef          	jal	ra,ffffffffc02061ca <vprintfmt>
}
...
strlen(const char *s) {
ffffffffc0206550:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0206552:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0206554:	cb81                	beqz	a5,ffffffffc0206564 <strlen+0x18>
        cnt ++;
ffffffffc0206556:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0206558:	00a707b3          	add	a5,a4,a0
ffffffffc020655c:	0007c783          	lbu	a5,0(a5)
ffffffffc0206560:	fbfd                	bnez	a5,ffffffffc0206556 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0206566:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206568:	e589                	bnez	a1,ffffffffc0206572 <strnlen+0xc>
ffffffffc020656a:	a811                	j	ffffffffc020657e <strnlen+0x18>
        cnt ++;
ffffffffc020656c:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020656e:	00f58863          	beq	a1,a5,ffffffffc020657e <strnlen+0x18>
ffffffffc0206572:	00f50733          	add	a4,a0,a5
ffffffffc0206576:	00074703          	lbu	a4,0(a4)
ffffffffc020657a:	fb6d                	bnez	a4,ffffffffc020656c <strnlen+0x6>
ffffffffc020657c:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020657e:	852e                	mv	a0,a1
ffffffffc0206580:	8082                	ret

ffffffffc0206582 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0206582:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0206584:	0005c703          	lbu	a4,0(a1)
ffffffffc0206588:	0785                	addi	a5,a5,1
ffffffffc020658a:	0585                	addi	a1,a1,1
ffffffffc020658c:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0206590:	fb75                	bnez	a4,ffffffffc0206584 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206594:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0206598:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020659c:	cb89                	beqz	a5,ffffffffc02065ae <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020659e:	0505                	addi	a0,a0,1
ffffffffc02065a0:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02065a2:	fee789e3          	beq	a5,a4,ffffffffc0206594 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc02065a6:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc02065aa:	9d19                	subw	a0,a0,a4
ffffffffc02065ac:	8082                	ret
ffffffffc02065ae:	4501                	li	a0,0
ffffffffc02065b0:	bfed                	j	ffffffffc02065aa <strcmp+0x16>

ffffffffc02065b2 <strchr>:
...
ffffffffc02065b6:	c799                	beqz	a5,ffffffffc02065c4 <strchr+0x12>
        if (*s == c) {
ffffffffc02065b8:	00f58763          	beq	a1,a5,ffffffffc02065c6 <strchr+0x14>
    while (*s != '\0') {
ffffffffc02065bc:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02065c0:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02065c2:	fbfd                	bnez	a5,ffffffffc02065b8 <strchr+0x6>
    }
    return NULL;
ffffffffc02065c4:	4501                	li	a0,0
}
...
ffffffffc02065de:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02065e0:	0005c703          	lbu	a4,0(a1)
ffffffffc02065e4:	0585                	addi	a1,a1,1
