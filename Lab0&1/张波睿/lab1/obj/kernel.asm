...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200414:	c0878793          	addi	a5,a5,-1016 # 80204018 <num>
    80200418:	6398                	ld	a4,0(a5)
            if (num >= TICK_NUM){
    8020041a:	06300693          	li	a3,99
    8020041e:	00004417          	auipc	s0,0x4
    80200422:	c0240413          	addi	s0,s0,-1022 # 80204020 <print_num>
            num++;
    ...
    80200460:	ba07be23          	sd	zero,-1092(a5) # 80204018 <num>
                print_num++;
...
0000000080200946 <sbi_set_timer>:
    ...
    8020094c:	6e073703          	ld	a4,1760(a4) # 80204028 <SBI_SET_TIMER>
